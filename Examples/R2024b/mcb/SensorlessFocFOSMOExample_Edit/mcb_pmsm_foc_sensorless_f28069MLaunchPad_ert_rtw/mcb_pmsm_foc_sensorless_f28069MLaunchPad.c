...
void mcb_pmsm_foc_MATLABFunction(real32_T rtu_e, real32_T rtu_P, real32_T
  rtu_I_Ts_speed, boolean_T rtu_reset, real32_T rtu_I0, real_T
  ...
  rtDW_MATLABFunction_mcb_pmsm_fo *localDW)
{
  ...
  /* MATLAB Function 'Current Control/Closed Loop/Current_Controllers/PI_Controller_Id/MATLAB Function': '<S44>:1' */
  if (rtu_reset) {
    /* '<S44>:1:21' */
    /* '<S44>:1:22' */
    localDW->integrator_state = rtu_I0;
  }
  ...
  /* '<S44>:1:32' */
  I_q_ref_unsat = rtu_P * rtu_e + localDW->integrator_state;

  /* '<S44>:1:35' */
  u1 = (real32_T)rtu_saturation_limit;
  if ((I_q_ref_unsat <= u1) || rtIsNaNF(u1)) {
    u1 = I_q_ref_unsat;
  }
  ...
  rtu_sine, real32_T rtu_cos, rtB_TwoinputsCRL_mcb_pmsm_foc_s *localB)
{
  ...
  /* AlgorithmDescriptorDelegate generated from: '<S107>/a16' */
 ...
 *    '<S281>/If Action Subsystem'
 *    '<S454>/If Action Subsystem'
 */
  ...
  *localZCE)
{
  ...
  /* Outputs for Triggered SubSystem: '<S327>/Dir_Sense' incorporates:
   *  TriggerPort: '<S335>/Trigger'
   */
  ...
  /* End of Outputs for SubSystem: '<S327>/Dir_Sense' */
}
  ...
  real32_T *rty_Out1, real32_T *rty_Out2)
{
  ...
  *rty_Out1 = -rtu_SigmaAlpha;
  ...
  /* SignalConversion generated from: '<S336>/SigmaBeta' */
...
{
  /* Start for S-Function (c2802xadc): '<S131>/IA//IB Measurement' */
  ...
  /* Start for S-Function (c280xgpio_do): '<S353>/Digital Output' */
  EALLOW;
  GpioCtrlRegs.GPBMUX2.all &= 0xFFFFFFCFU;
  GpioCtrlRegs.GPBDIR.all |= 0x40000U;
  EDIS;

  /* Start for S-Function (c2802xpwm): '<S353>/ePWM1' */
  ...
  /* Start for S-Function (c2802xpwm): '<S353>/ePWM2' */
  ...
  /* Start for S-Function (c2802xpwm): '<S353>/ePWM3' */
  ...
  mcb_pms_MATLABFunction_Init(&mcb_pmsm_foc_sensorless_f_DWork.sf_MATLABFunction);

  /* SystemInitialize for MATLAB Function: '<S27>/MATLAB Function' */
  mcb_pms_MATLABFunction_Init
    (&mcb_pmsm_foc_sensorless_f_DWork.sf_MATLABFunction_d);

  /* SystemInitialize for IfAction SubSystem: '<S133>/Extended EMF Observer' */
  ...
  /* SystemInitialize for IfAction SubSystem: '<S163>/DifferentiationMethod' */
  /* InitializeConditions for Delay: '<S228>/Delay2' */
  mcb_pmsm_foc_sensorless_f_DWork.Delay2_DSTATE_c = 0.0F;

  /* InitializeConditions for Delay: '<S228>/Delay3' */
  ...
  /* InitializeConditions for Delay: '<S229>/Delay3' */
  mcb_pmsm_foc_sensorless_f_DWork.Delay3_DSTATE_ds = 0.0F;

  /* End of SystemInitialize for SubSystem: '<S163>/DifferentiationMethod' */

  /* SystemInitialize for IfAction SubSystem: '<S163>/IntegralMethod' */
  ...
  /* End of SystemInitialize for SubSystem: '<S163>/IntegralMethod' */

  /* SystemInitialize for IfAction SubSystem: '<S163>/OptimizedDifferentiationMethod' */
  ...
  /* End of SystemInitialize for SubSystem: '<S163>/OptimizedDifferentiationMethod' */

  /* SystemInitialize for Merge: '<S163>/Merge' */
  mcb_pmsm_foc_sensorless_f2806_B.Merge_i = 0.0F;

  /* End of SystemInitialize for SubSystem: '<S133>/Extended EMF Observer' */

  /* SystemInitialize for IfAction SubSystem: '<S133>/Flux Observer' */
  ...
  /* End of SystemInitialize for SubSystem: '<S133>/Flux Observer' */

  /* SystemInitialize for IfAction SubSystem: '<S133>/Sliding Mode Observer' */
  ...
  /* End of SystemInitialize for SubSystem: '<S133>/Sliding Mode Observer' */
...
void mcb_pm_CurrentControl_Reset(void)
{
  ...
  mcb_pm_MATLABFunction_Reset(&mcb_pmsm_foc_sensorless_f_DWork.sf_MATLABFunction);
}
...
void mcb_pmsm_foc_CurrentControl(void)
{
  ...
  /* S-Function (c2802xadc): '<S131>/IA//IB Measurement' */
  {
  ...
  /* ArithShift: '<S132>/Q17 per unit conversion' incorporates:
   *  Sum: '<S132>/Add'
   */
   ...
   *  ArithShift: '<S132>/Q17 per unit conversion'
   */
  ...
  /* Outputs for IfAction SubSystem: '<S133>/Flux Observer' incorporates:
   *  ActionPort: '<S135>/Action Port'
   */
  /* SwitchCase: '<S133>/Switch Case' incorporates:
   *  Constant: '<S291>/FilterConstant'
   *  Constant: '<S291>/OneMinusFilterConstant'
  ...
  Bias = mcb_pmsm_foc_sensorless_f2806_B.Delay5[0];
  Product_am = Bias * 0.0005F;

  /* End of Outputs for SubSystem: '<S133>/Flux Observer' */
   ...
   *  Sum: '<S293>/Sum'
   */
  mcb_pmsm_foc_sensorless_f2806_B.Sum_bf[0] = Bias - Product_am;
  Bias = mcb_pmsm_foc_sensorless_f2806_B.Delay5[1];
  Product_am = Bias * 0.0005F;
   ...
   *  Sum: '<S293>/Sum'
   */
  mcb_pmsm_foc_sensorless_f2806_B.Sum_bf[1] = Bias - Product_am;
  Bias = mcb_pmsm_foc_sensorless_f2806_B.Delay5[2];
  Product_am = Bias * 0.0005F;
   ...
   *  Sum: '<S293>/Sum'
   */
  mcb_pmsm_foc_sensorless_f2806_B.Sum_bf[2] = Bias - Product_am;
  Bias = mcb_pmsm_foc_sensorless_f2806_B.Delay5[3];
  Product_am = Bias * 0.0005F;
   ...
   */
  /* SwitchCase: '<S133>/Switch Case' incorporates:
   *  AlgorithmDescriptorDelegate generated from: '<S303>/a16'
   ...
   *  DataTypeConversion: '<S325>/DTC'
   *  Delay: '<S290>/Delay'
   *  Delay: '<S308>/Delay'
   *  Delay: '<S308>/Delay1'
   *  Delay: '<S316>/Delay'
   *  Delay: '<S316>/Delay1'
   *  Gain: '<S135>/elect2mech'
   *  Gain: '<S290>/PositionToCount'
   *  Gain: '<S290>/SpeedGain'
   *  Gain: '<S304>/Gain'
   ...
   *  SignalConversion generated from: '<S135>/Position//Speed'
   *  Sum: '<S290>/SpeedCount'
   *  Sum: '<S293>/Sum'
   *  Sum: '<S306>/Sum1'
   *  Sum: '<S306>/Sum3'
   ...
   * */
  mcb_pmsm_foc_sensorless_f2806_B.Sum_bf[3] = Bias - Product_am;
  ...
  /* Outputs for Atomic SubSystem: '<S302>/atan2' */
  mcb_pmsm_foc_sensorless_f2806_B.Atan2 = atan2f
    (mcb_pmsm_foc_sensorless_f2806_B.Switch_g,
     mcb_pmsm_foc_sensorless_f2806_B.Switch_h);

  /* Outputs for Atomic SubSystem: '<S303>/Per Unit' */
  ...
  /* End of Outputs for SubSystem: '<S303>/Per Unit' */
  mcb_pmsm_foc_sensorless_f2806_B.Switch_ds =
    mcb_pmsm_foc_sensorless_f2806_B.Switch_c;
  mcb_pmsm_foc_sensorless_f2806_B.algDD =
    mcb_pmsm_foc_sensorless_f2806_B.Switch_ds;

  /* End of Outputs for SubSystem: '<S302>/atan2' */
  ...
  /* Outputs for Enabled SubSystem: '<S105>/Subsystem' incorporates:
   *  EnablePort: '<S106>/Enable'
   */
  if (mcb_pmsm_foc_sensorless_f2806_B.Delay_kh) {
    /* SignalConversion generated from: '<S106>/Input' */
    mcb_pmsm_foc_sensorless_f2806_B.Input_h =
      mcb_pmsm_foc_sensorless_f2806_B.Gain;
  }

  /* End of Outputs for SubSystem: '<S105>/Subsystem' */
  ...
  /* Sum: '<S105>/Add' */
  mcb_pmsm_foc_sensorless_f2806_B.Add = mcb_pmsm_foc_sensorless_f2806_B.Input_h
    + mcb_pmsm_foc_sensorless_f2806_B.Delay_g;

  /* DataTypeConversion: '<S105>/Data Type Conversion' */
  mcb_pmsm_foc_sensorless_f2806_B.DataTypeConversion_ey = (int16_T)(real32_T)
    floor(mcb_pmsm_foc_sensorless_f2806_B.Add);
  ...
  /* Sum: '<S105>/Add1' */
  mcb_pmsm_foc_sensorless_f2806_B.Add1 = mcb_pmsm_foc_sensorless_f2806_B.Add -
    mcb_pmsm_foc_sensorless_f2806_B.DataTypeConversion1_d;
  ...
  /* DataTypeConversion: '<S109>/Get_Integer' */
  ...
  /* Selector: '<S109>/Lookup' incorporates:
   *  Constant: '<S109>/sine_table_values'
   */
  mcb_pmsm_foc_sensorless_f2806_B.Lookup_f[0] =
    mcb_pmsm_foc_sensorless__ConstP.pooled30[(int16_T)Sum_k];
  ...
  mcb_pmsm_foc_sensorless_f2806_B.Product_b =
    mcb_pmsm_foc_sensorless_f2806_B.Sum_m * 1.275841F;
   ...
   *  Constant: '<S27>/Kp'
   */
  mcb_pmsm_foc_MATLABFunction(mcb_pmsm_foc_sensorless_f2806_B.Sum_m, 1.275841F,
    0.0429887548F, mcb_pmsm_foc_sensorless_f2806_B.LogicalOperator,
    mcb_pmsm_foc_sensorless_f2806_B.Sum1, 1.0,
    &mcb_pmsm_foc_sensorless_f2806_B.sf_MATLABFunction_d,
    &mcb_pmsm_foc_sensorless_f_DWork.sf_MATLABFunction_d);
  ...
  if (mcb_pmsm_foc_sensorless_f2806_B.DataStoreRead1_b) {
    ...
    mcb_pmsm_foc_sensorless_f2806_B.Switch_j =
      mcb_pmsm_foc_sensorless_f2806_B.sf_MATLABFunction_d.I_q_ref;
  } else {
  ...
  mcb_pmsm_foc_sensorless_f2806_B.Product_e =
    mcb_pmsm_foc_sensorless_f2806_B.Sum_g * 1.275841F;
   ...
   *  Constant: '<S26>/Kp'
   */
  mcb_pmsm_foc_MATLABFunction(mcb_pmsm_foc_sensorless_f2806_B.Sum_g, 1.275841F,
    0.0429887548F, mcb_pmsm_foc_sensorless_f2806_B.LogicalOperator_e,
    mcb_pmsm_foc_sensorless_f2806_B.Sum1_a, 1.0,
    &mcb_pmsm_foc_sensorless_f2806_B.sf_MATLABFunction,
    &mcb_pmsm_foc_sensorless_f_DWork.sf_MATLABFunction);
   ...
   *  Constant: '<S43>/FilterConstant'
   *  Constant: '<S43>/OneMinusFilterConstant'
   */
  ...
  if (mcb_pmsm_foc_sensorless_f2806_B.DataStoreRead1_f) {
    ...
    mcb_pmsm_foc_sensorless_f2806_B.Switch_d =
      mcb_pmsm_foc_sensorless_f2806_B.sf_MATLABFunction.I_q_ref;
  } else {
  ...
  /* Product: '<S103>/qcos' */
  mcb_pmsm_foc_sensorless_f2806_B.qcos =
    mcb_pmsm_foc_sensorless_f2806_B.Merge_m[1] *
    mcb_pmsm_foc_sensorless_f2806_B.Sum6_c;

  /* Product: '<S103>/dsin' */
  mcb_pmsm_foc_sensorless_f2806_B.dsin =
    mcb_pmsm_foc_sensorless_f2806_B.Merge_m[0] *
    mcb_pmsm_foc_sensorless_f2806_B.Sum4_h;
  ...
  /* Product: '<S103>/dcos' */
  mcb_pmsm_foc_sensorless_f2806_B.dcos =
    mcb_pmsm_foc_sensorless_f2806_B.Merge_m[0] *
    mcb_pmsm_foc_sensorless_f2806_B.Sum6_c;

  /* Product: '<S103>/qsin' */
  mcb_pmsm_foc_sensorless_f2806_B.qsin =
    mcb_pmsm_foc_sensorless_f2806_B.Merge_m[1] *
    mcb_pmsm_foc_sensorless_f2806_B.Sum4_h;
  ...
  /* AlgorithmDescriptorDelegate generated from: '<S103>/a16' */
  ...
  /* DataTypeConversion: '<S126>/Data Type Conversion3' incorporates:
   *  DataTypeConversion: '<S126>/Data Type Conversion'
   */
  ...
  if (mcb_pmsm_foc_sensorless_f2806_B.Output == 0U) {
     ...
     *  Constant: '<S128>/End'
     *  SignalConversion generated from: '<S128>/Data_out'
     */
  ...
  /* Outputs for Iterator SubSystem: '<S354>/CodeGeneration' incorporates:
   *  WhileIterator: '<S355>/While Iterator'
   */
  s355_iter = 1;
  do {
    mcb_pmsm_foc_sensorless_f2806_B.WhileIterator = s355_iter;
  ...
  /* End of Outputs for SubSystem: '<S354>/CodeGeneration' */
  ...
  /* S-Function (c280xgpio_do): '<S353>/Digital Output' */
  {
  ...
  if (mcb_pmsm_foc_sensorless_f2806_B.DataTypeConversion_c >= 0.5F) {
    ...
    Bias = mcb_pmsm_foc_sensorless_f2806_B.add_b;
    if ((Product_am <= Bias) || rtIsNaNF(Bias)) {
      Bias = Product_am;
    }

    Product_am = mcb_pmsm_foc_sensorless_f2806_B.add_c;
    if ((!(Bias <= Product_am)) && (!rtIsNaNF(Product_am))) {
      Bias = Product_am;
    }

    /* MinMax: '<S120>/Min' */
    mcb_pmsm_foc_sensorless_f2806_B.Min = Bias;
    ...
    /* Gain: '<S14>/Gain' */
    Bias = 0.5F * mcb_pmsm_foc_sensorless_f2806_B.Gain_c[0];
    mcb_pmsm_foc_sensorless_f2806_B.Gain_c1[0] = Bias;

    /* Sum: '<S14>/Sum' incorporates:
     *  Constant: '<S14>/Constant'
     */
    Bias += 0.5F;
    mcb_pmsm_foc_sensorless_f2806_B.PWM_Duty_Cycles[0] = Bias;

    /* Gain: '<S353>/Scale_to_PWM_Counter_PRD' */
    ...
    /* Gain: '<S14>/Gain' */
    Bias = 0.5F * mcb_pmsm_foc_sensorless_f2806_B.Gain_c[1];
    mcb_pmsm_foc_sensorless_f2806_B.Gain_c1[1] = Bias;

    /* Sum: '<S14>/Sum' incorporates:
     *  Constant: '<S14>/Constant'
     */
    Bias += 0.5F;
    mcb_pmsm_foc_sensorless_f2806_B.PWM_Duty_Cycles[1] = Bias;
    ...
    /* Gain: '<S14>/Gain' */
    Bias = 0.5F * mcb_pmsm_foc_sensorless_f2806_B.Gain_c[2];
    mcb_pmsm_foc_sensorless_f2806_B.Gain_c1[2] = Bias;

    /* Sum: '<S14>/Sum' incorporates:
     *  Constant: '<S14>/Constant'
     */
    Bias += 0.5F;
    mcb_pmsm_foc_sensorless_f2806_B.PWM_Duty_Cycles[2] = Bias;
  ...
  /* S-Function (c2802xpwm): '<S353>/ePWM1' */
  ...
  /* S-Function (c2802xpwm): '<S353>/ePWM2' */
  ...
  /* S-Function (c2802xpwm): '<S353>/ePWM3' */
...
void mcb__SPIMasterTransfer_Init(rtDW_SPIMasterTransfer_mcb_pmsm *localDW)
{
  ...
  /* Start for MATLABSystem: '<S366>/SPI Master Transfer' */
  ...
  *localB, rtDW_SPIMasterTransfer_mcb_pmsm *localDW)
{
  ...
  /* MATLABSystem: '<S366>/SPI Master Transfer' */
...
void mcb__SPIMasterTransfer_Term(rtDW_SPIMasterTransfer_mcb_pmsm *localDW)
{
  ...
  /* Terminate for MATLABSystem: '<S366>/SPI Master Transfer' */
  ...
  /* End of Terminate for MATLABSystem: '<S366>/SPI Master Transfer' */
}
...
{
  /* InitializeConditions for RateLimiter: '<S381>/Rate Limiter' */
  localDW->PrevY = 0.2F;

  /* InitializeConditions for RateLimiter: '<S381>/Rate Limiter1' */
  localDW->PrevY_f = -0.2F;

  /* SystemInitialize for MATLAB Function: '<S380>/MATLAB Function' */
  mcb_pms_MATLABFunction_Init(&localDW->sf_MATLABFunction);
}
  ...
  *localDW)
{
  ...
  /* RateLimiter: '<S381>/Rate Limiter' */
  rateLimiterRate = rtu_Speed_Ref_PU - localDW->PrevY;
  if (rateLimiterRate > 0.000993246F) {
    /* RateLimiter: '<S381>/Rate Limiter' */
    localB->RateLimiter = localDW->PrevY + 0.000993246F;
  } else if (rateLimiterRate < -0.000993246F) {
    /* RateLimiter: '<S381>/Rate Limiter' */
    localB->RateLimiter = localDW->PrevY - 0.000993246F;
  } else {
    /* RateLimiter: '<S381>/Rate Limiter' */
  ...
  /* End of RateLimiter: '<S381>/Rate Limiter' */

  /* RateLimiter: '<S381>/Rate Limiter1' */
  ...
  /* End of RateLimiter: '<S381>/Rate Limiter1' */
   ...
   *  Constant: '<S384>/FilterConstant'
   *  Constant: '<S384>/OneMinusFilterConstant'
   */
   ...
   *  Constant: '<S380>/Kp1'
   */
  localB->Product_g = 0.382961661F * localB->Sum;
   ...
   *  Constant: '<S380>/Kp1'
   */
  mcb_pmsm_foc_MATLABFunction(localB->Sum, 0.382961661F, 0.002528F,
    localB->LogicalOperator, localB->Sum1, 1.0, &localB->sf_MATLABFunction,
...
/* Output and update for function-call system: '<S443>/RunMode.ComputeId0' */
...
void mcb_pmsm_foc_sensorless_f28069MLaunchPad_step0(void) /* Sample time: [0.0005s, 0.0s] */
{
    ...
    if (out) {
      ...
      switch (mcb_pmsm_foc_sensorless_f_DWork.is_RunMode) {
       case mcb_pmsm_foc_IN_InitOpenLoopRun:
        ...
        /* During 'InitOpenLoopRun': '<S443>:36' */
        ...
        switch (mcb_pmsm_foc_sensorless_f_DWork.is_NegativeSpeedRun) {
         case mcb_pmsm_f_IN_ClosedLoopRun_NEG:
          ...
          if (mcb_pmsm_foc_sensorless_f2806_B.SpdCmd > -0.15F) {
            ...
            /* Entry 'TransferToOpenLoop_NEG': '<S443>:140' */
         ...
         case mcb_pmsm_foc__IN_OpenLoopNegRun:
          /* During 'OpenLoopNegRun': '<S443>:112' */
          /* Transition: '<S443>:122' */
          if (mcb_pmsm_foc_sensorless_f2806_B.SpdCmd > 0.0F) {
            /* Transition: '<S443>:123' */
            mcb_pmsm_foc_sensorless_f_DWork.is_NegativeSpeedRun =
            ...
            if (mcb_pmsm_foc_sensorless_f2806_B.SpdRef > -0.2F) {
              ...
              /* Entry 'PrepareNegCLSwitch': '<S443>:127' */
              mcb_pmsm_foc_sensorless_f2806_B.Id0_out =
                mcb_pmsm_foc_sensorless_f2806_B.UnitDelay;
              mcb_pmsm_foc_sensorless_f2806_B.SpdRef = -0.2F;
              ...
              /* Entry 'TransferToNegClosedLoop': '<S443>:129' */
         ...
         case mcb_pmsm__IN_PrepareNegCLSwitch:
          /* During 'PrepareNegCLSwitch': '<S443>:127' */
         ...
         case mcb__IN_TransferToNegClosedLoop:
          ...
          /* During 'TransferToNegClosedLoop': '<S443>:129' */
          ...
          if (out) {
            ...
            /* Entry 'ClosedLoopRun_NEG': '<S443>:132' */
            mcb_pmsm_foc_sensorless_f2806_B.SpdRef =
              mcb_pmsm_foc_sensorless_f2806_B.SpdCmd;
            ...
            /* Outputs for Function Call SubSystem: '<S443>/RunMode.ComputeId0' */
            /* Simulink Function 'ComputeId0': '<S443>:103' */
            ...
            /* End of Outputs for SubSystem: '<S443>/RunMode.ComputeId0' */
            mcb_pmsm_foc_sensorless_f2806_B.Id0_out =
         ...
         default:
          /* During 'TransferToOpenLoop_NEG': '<S443>:140' */
          if (mcb_pmsm_foc_sensorless_f_DWork.temporalCounter_i1 >= 2000U) {
            /* Transition: '<S443>:142' */
            mcb_pmsm_foc_sensorless_f_DWork.is_NegativeSpeedRun =
              mcb_pmsm_foc_IN_NO_ACTIVE_CHILD;
        ...
        switch (mcb_pmsm_foc_sensorless_f_DWork.is_PositiveSpeedRun) {
         case mcb_pmsm_fo_IN_ClosedLoopPosRun:
          ...
          if (mcb_pmsm_foc_sensorless_f2806_B.SpdCmd < 0.15F) {
            ...
            /* Entry 'TransferToOpenLoop': '<S443>:80' */
            mcb_pmsm_foc_sensorless_f2806_B.SpdRef = 0.206F;
          } else {
            mcb_pmsm_foc_sensorless_f2806_B.SpdRef =
              mcb_pmsm_foc_sensorless_f2806_B.SpdCmd;
         ...
         case mcb_pmsm_foc__IN_OpenLoopPosRun:
          ...
          if (mcb_pmsm_foc_sensorless_f2806_B.SpdCmd > 0.2F) {
            ...
            if (mcb_pmsm_foc_sensorless_f2806_B.SpdRef >= 0.2F) {
              ...
              /* Entry 'TransferToPosClosedLoop': '<S443>:40' */
              mcb_pmsm_foc_sensorless_f2806_B.EnClosedLoop = true;
              mcb_pmsm_foc_sensorless_f2806_B.Id0_out =
                mcb_pmsm_foc_sensorless_f2806_B.UnitDelay;
            } else if (mcb_pmsm_foc_sensorless_f2806_B.SpdRef < 0.2F) {
              ...
              /* Entry 'PreparePosCLSwitch': '<S443>:96' */
              mcb_pmsm_foc_sensorless_f2806_B.Id0_out =
                mcb_pmsm_foc_sensorless_f2806_B.UnitDelay;
              mcb_pmsm_foc_sensorless_f2806_B.SpdRef = 0.2F;
            } else {
         ...
         case mcb_pmsm__IN_PreparePosCLSwitch:
          /* During 'PreparePosCLSwitch': '<S443>:96' */
          if (mcb_pmsm_foc_sensorless_f_DWork.temporalCounter_i1 >= 2000U) {
            /* Transition: '<S443>:98' */
            mcb_pmsm_foc_sensorless_f_DWork.temporalCounter_i1 = 0U;
            mcb_pmsm_foc_sensorless_f_DWork.is_PositiveSpeedRun =
         ...
         case mcb_pmsm__IN_TransferToOpenLoop:
          /* During 'TransferToOpenLoop': '<S443>:80' */
          if (mcb_pmsm_foc_sensorless_f_DWork.temporalCounter_i1 >= 2000U) {
            /* Transition: '<S443>:81' */
            mcb_pmsm_foc_sensorless_f_DWork.is_PositiveSpeedRun =
              mcb_pmsm_foc_IN_NO_ACTIVE_CHILD;
         ...
         default:
          ...
          /* During 'TransferToPosClosedLoop': '<S443>:40' */
          out = ((mcb_pmsm_foc_sensorless_f_DWork.temporalCounter_i1 >= 4000U) &&
                 (mcb_pmsm_foc_sensorless_f2806_B.Id0_out <= 0.001F));
          if (out) {
            /* Transition: '<S443>:56' */
            ...
            /* Entry 'ClosedLoopPosRun': '<S443>:55' */
            mcb_pmsm_foc_sensorless_f2806_B.SpdRef =
              mcb_pmsm_foc_sensorless_f2806_B.SpdCmd;
            mcb_pmsm_foc_sensorless_f2806_B.Id0_out = 0.0F;
          } else {
  ...
  if (mcb_pmsm_foc_sensorless_f2806_B.NOT) {
    ...
    /* DataTypeConversion: '<S454>/Data Type Conversion' */
    mcb_pmsm_foc_sensorless_f2806_B.DataTypeConversion_b =
      mcb_pmsm_foc_sensorless_f2806_B.Compare;

    /* If: '<S454>/If' */
    if (mcb_pmsm_foc_sensorless_f2806_B.DataTypeConversion_b > 0U) {
      /* Outputs for IfAction SubSystem: '<S454>/If Action Subsystem' incorporates:
      ...
      /* End of Outputs for SubSystem: '<S454>/If Action Subsystem' */
    } else {
      /* Outputs for IfAction SubSystem: '<S454>/If Action Subsystem1' incorporates:
      ...
      /* End of Outputs for SubSystem: '<S454>/If Action Subsystem1' */
    }
    ...
    /* Outputs for Atomic SubSystem: '<S447>/Two inputs CRL' */
    ...
    /* End of Outputs for SubSystem: '<S447>/Two inputs CRL' */

    /* DataStoreWrite: '<S442>/Data Store Write1' */
    mcb_pmsm_foc_sensorless_f_DWork.Vd_out_initial =
      mcb_pmsm_foc_sensorless_f2806_B.TwoinputsCRL_j.algDD_o1;

    /* DataStoreWrite: '<S442>/Data Store Write2' */
    mcb_pmsm_foc_sensorless_f_DWork.Vq_out_initial =
    ...
    /* DataStoreRead: '<S442>/Data Store Read4' */
    mcb_pmsm_foc_sensorless_f2806_B.DataStoreRead4 =
      mcb_pmsm_foc_sensorless_f_DWork.Ib_meas_PU;

    /* Outputs for Atomic SubSystem: '<S448>/Two phase CRL wrap' */
    ...
    /* End of Outputs for SubSystem: '<S448>/Two phase CRL wrap' */

    /* Outputs for Atomic SubSystem: '<S445>/Two inputs CRL' */
    mcb_pmsm_foc_s_TwoinputsCRL
    ...
    /* End of Outputs for SubSystem: '<S445>/Two inputs CRL' */

    /* DataStoreWrite: '<S442>/Data Store Write6' */
  ...
  mcb_pmsm_foc_sensorless_f_DWork.RT2_Buffer[1 +
    ((mcb_pmsm_foc_sensorless_f_DWork.RT2_ActiveBufIdx == 0) << 1U)] =
    mcb_pmsm_foc_sensorless_f2806_B.SpeedControl.sf_MATLABFunction.I_q_ref;
...
void mcb_pmsm_foc_sensorless_f28069MLaunchPad_step1(void) /* Sample time: [0.5s, 0.0s] */
{
  ...
  /* S-Function (c280xgpio_do): '<S375>/Digital Output1' incorporates:
   *  Constant: '<S4>/RED_LED'
   */
  {
...
void mcb_pmsm_foc_sensorless_f28069MLaunchPad_initialize(void)
{
...

  {
    ...
    mcb_pmsm_foc_sensorless_f2806_B.Product = 0.0F;
    mcb_pmsm_foc_sensorless_f2806_B.Sum4 = 0.0F;
    mcb_pmsm_foc_sensorless_f2806_B.Sum5 = 0.0F;
    mcb_pmsm_foc_sensorless_f2806_B.Product1 = 0.0F;
    ...
    mcb_pmsm_foc_sensorless_f2806_B.Add = 0.0F;
    mcb_pmsm_foc_sensorless_f2806_B.DataTypeConversion1_d = 0.0F;
    mcb_pmsm_foc_sensorless_f2806_B.Add1 = 0.0F;
    mcb_pmsm_foc_sensorless_f2806_B.Switch = 0.0F;
    ...
    mcb_pmsm_foc_sensorless_f2806_B.qcos = 0.0F;
    mcb_pmsm_foc_sensorless_f2806_B.dsin = 0.0F;
    mcb_pmsm_foc_sensorless_f2806_B.sum_beta = 0.0F;
    mcb_pmsm_foc_sensorless_f2806_B.dcos = 0.0F;
    mcb_pmsm_foc_sensorless_f2806_B.qsin = 0.0F;
    mcb_pmsm_foc_sensorless_f2806_B.sum_alpha = 0.0F;
    ...
    mcb_pmsm_foc_sensorless_f2806_B.sf_MATLABFunction_d.I_q_ref = 0.0F;
    mcb_pmsm_foc_sensorless_f2806_B.sf_MATLABFunction.I_q_ref = 0.0F;
  ...
  mcb_pmsm_foc_sensorless_f_DWork.SpeedControl.sf_MATLABFunction.integrator_state
    = 0.0F;
  mcb_pmsm_foc_sensorless_f_DWork.sf_MATLABFunction_d.integrator_state = 0.0F;
  mcb_pmsm_foc_sensorless_f_DWork.sf_MATLABFunction.integrator_state = 0.0F;

  {
    ...
    /* SystemInitialize for S-Function (HardwareInterrupt_sfun): '<S360>/Hardware Interrupt' incorporates:
     *  SubSystem: '<Root>/Current Control'
     */
    mcb_pms_CurrentControl_Init();

    /* SystemInitialize for S-Function (HardwareInterrupt_sfun): '<S362>/Hardware Interrupt' incorporates:
    ...
    /* Start for S-Function (c280xgpio_do): '<S375>/Digital Output1' */
    EALLOW;
    ...
    /* Start for S-Function (c280xgpio_do): '<S366>/Digital Output' */
    EALLOW;
    GpioCtrlRegs.GPBMUX2.all &= 0xFFFFFFCFU;
    GpioCtrlRegs.GPBDIR.all |= 0x40000U;
    EDIS;

    /* SystemInitialize for Enabled SubSystem: '<S364>/Calculate ADC Offset ' */
    /* SystemInitialize for Iterator SubSystem: '<S365>/For Iterator Subsystem' */
    /* Start for S-Function (c2802xadc): '<S368>/IA//IB Measurement' */
    if (MW_adcInitFlag == 0U) {
      InitAdc();
      MW_adcInitFlag = 1U;
    }
    ...
    /* End of SystemInitialize for SubSystem: '<S365>/For Iterator Subsystem' */
    /* End of SystemInitialize for SubSystem: '<S364>/Calculate ADC Offset ' */
    ...
    /* S-Function (c280xgpio_do): '<S366>/Digital Output' incorporates:
     *  Constant: '<S366>/DRV830x_Enable'
     */
    {
      if ((1U)) {
        GpioDataRegs.GPBSET.bit.GPIO50 = 1U;
    ...
    /* Outputs for Enabled SubSystem: '<S364>/Calculate ADC Offset ' incorporates:
     *  EnablePort: '<S365>/Enable'
     */
    /* Outputs for Iterator SubSystem: '<S365>/For Iterator Subsystem' incorporates:
     *  ForIterator: '<S368>/For Iterator'
     */
    for (s368_iter = 1U; s368_iter < 17U; s368_iter++) {
      /* Outputs for Iterator SubSystem: '<S365>/For Iterator Subsystem' incorporates:
       *  ForIterator: '<S368>/For Iterator'
       */
      mcb_pmsm_foc_sensorless_f2806_B.ForIterator = s368_iter;

      /* S-Function (c2802xadc): '<S368>/IA//IB Measurement' */
      {
        /*  Internal Reference Voltage : Fixed scale 0 to 3.3 V range.  */
        /*  External Reference Voltage : Allowable ranges of VREFHI(ADCINA0) = 3.3 and VREFLO(tied to ground) = 0  */
      ...
      if (mcb_pmsm_foc_sensorless_f2806_B.ForIterator > 8U) {
        ...
        /* Update for Memory: '<S373>/Memory1' */
        mcb_pmsm_foc_sensorless_f_DWork.Memory1_PreviousInput =
          mcb_pmsm_foc_sensorless_f2806_B.Sum1_dq;
    ...
    /* End of Outputs for SubSystem: '<S365>/For Iterator Subsystem' */
    ...
    if ((mcb_pmsm_foc_sensorless_f2806_B.Divide_h > 1500U) &&
      ...
      /* Outputs for IfAction SubSystem: '<S365>/If Action Subsystem' incorporates:
       *  ActionPort: '<S369>/Action Port'
       */
      /* DataStoreWrite: '<S369>/Data Store Write1' */
      mcb_pmsm_foc_sensorless_f_DWork.IaOffset =
        mcb_pmsm_foc_sensorless_f2806_B.Divide_h;

      /* End of Outputs for SubSystem: '<S365>/If Action Subsystem' */
    } else {
    ...
    if ((mcb_pmsm_foc_sensorless_f2806_B.Divide1_e > 1500U) &&
       ...
       */
      /* DataStoreWrite: '<S371>/Data Store Write2' */
      mcb_pmsm_foc_sensorless_f_DWork.IbOffset =
    ...
    /* End of If: '<S365>/If1' */
    /* End of Outputs for SubSystem: '<S364>/Calculate ADC Offset ' */

    /* Logic: '<S364>/NOT' */
    mcb_pmsm_foc_sensorless_f2806_B.NOT_h = false;

    /* Outputs for Enabled SubSystem: '<S364>/Default ADC Offset' incorporates:
    ...
    if (mcb_pmsm_foc_sensorless_f2806_B.NOT_h) {
      ...
      /* DataStoreWrite: '<S367>/Data Store Write2' incorporates:
       *  Constant: '<S367>/Constant1'
       */
      mcb_pmsm_foc_sensorless_f_DWork.IbOffset = 2082U;
    }

    /* End of Outputs for SubSystem: '<S364>/Default ADC Offset' */
...
/* Hardware Interrupt Block: '<S360>/Hardware Interrupt' */
  ...
  if (1 == runModel) {
    {
      ...
      /* S-Function (HardwareInterrupt_sfun): '<S360>/Hardware Interrupt' */
      mcb_pmsm_foc_CurrentControl();

      /* End of Outputs for S-Function (HardwareInterrupt_sfun): '<S360>/Hardware Interrupt' */
...
/* Hardware Interrupt Block: '<S362>/Hardware Interrupt' */
interrupt void SCIRXINTA(void)
{
  ...
  if (1 == runModel) {
    {
      /* S-Function (HardwareInterrupt_sfun): '<S362>/Hardware Interrupt' */
      ...
      /* End of Outputs for S-Function (HardwareInterrupt_sfun): '<S362>/Hardware Interrupt' */
