###########################################################################
## Makefile generated for component 'mcb_pmsm_foc_sensorless_f28069MLaunchPad'. 
## 
## Makefile     : mcb_pmsm_foc_sensorless_f28069MLaunchPad.mk
## Generated on : Tue Mar 25 10:46:01 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/mcb_pmsm_foc_sensorless_f28069MLaunchPad.out
...
PRODUCT_NAME              = mcb_pmsm_foc_sensorless_f28069MLaunchPad
MAKEFILE                  = mcb_pmsm_foc_sensorless_f28069MLaunchPad.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2024b
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2024b/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = C:/Users/giova/Documents/MATLAB/Examples/R2024b/mcb/SensorlessFocFOSMOExample
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = TI C28x
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/mcb_pmsm_foc_sensorless_f28069MLaunchPad.out
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(MATLAB_ROOT)/toolbox/target/shared/svd/common/include -I$(MATLAB_ROOT)/toolbox/c2b/tic2000/inc -I$(START_DIR)/mcb_pmsm_foc_sensorless_f28069MLaunchPad_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/c2b/tic2000/src -I$(MATLAB_ROOT)/toolbox/c2b/tic2000_shared/src -I$(MATLAB_ROOT)/toolbox/c2b/tic2000_shared/inc -IC:/ti/controlSUITE/device_support/f2806x/v151/F2806x_common/include -IC:/ti/controlSUITE/device_support/f2806x/v151/F2806x_headers/include -IC:/ti/controlSUITE/libs/math/CLAmath/v400/include -IC:/ti/controlSUITE/libs/math/IQmath/v160/include -I$(MATLAB_ROOT)/toolbox/shared/can/src/scanutil -IC:/ti/controlSUITE/libs/utilities/hrcap_hccal/type0/v110/include -I$(MATLAB_ROOT)/toolbox/c2b/tic2000_soc/src/ipclite -I$(MATLAB_ROOT)/toolbox/c2b/tic2000_soc/inc/ipclite
...
DEFINES_STANDARD = -DMODEL=mcb_pmsm_foc_sensorless_f28069MLaunchPad -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.obj : $(START_DIR)/mcb_pmsm_foc_sensorless_f28069MLaunchPad_ert_rtw/%.cla
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/mcb_pmsm_foc_sensorless_f28069MLaunchPad_ert_rtw/%.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/mcb_pmsm_foc_sensorless_f28069MLaunchPad_ert_rtw/%.asm
	$(AS) $(ASFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/mcb_pmsm_foc_sensorless_f28069MLaunchPad_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) --output_file="$@" "$<"
...
MW_c28xx_csl.obj : $(START_DIR)/mcb_pmsm_foc_sensorless_f28069MLaunchPad_ert_rtw/MW_c28xx_csl.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


MW_c28xx_board.obj : $(START_DIR)/mcb_pmsm_foc_sensorless_f28069MLaunchPad_ert_rtw/MW_c28xx_board.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


DSP28xx_SciUtil.obj : $(START_DIR)/mcb_pmsm_foc_sensorless_f28069MLaunchPad_ert_rtw/DSP28xx_SciUtil.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


MW_c28xx_adc.obj : $(START_DIR)/mcb_pmsm_foc_sensorless_f28069MLaunchPad_ert_rtw/MW_c28xx_adc.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


MW_c28xx_pwm.obj : $(START_DIR)/mcb_pmsm_foc_sensorless_f28069MLaunchPad_ert_rtw/MW_c28xx_pwm.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


ert_main.obj : $(START_DIR)/mcb_pmsm_foc_sensorless_f28069MLaunchPad_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


mcb_pmsm_foc_sensorless_f28069MLaunchPad.obj : $(START_DIR)/mcb_pmsm_foc_sensorless_f28069MLaunchPad_ert_rtw/mcb_pmsm_foc_sensorless_f28069MLaunchPad.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


mcb_pmsm_foc_sensorless_f28069MLaunchPad_data.obj : $(START_DIR)/mcb_pmsm_foc_sensorless_f28069MLaunchPad_ert_rtw/mcb_pmsm_foc_sensorless_f28069MLaunchPad_data.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


rtGetInf.obj : $(START_DIR)/mcb_pmsm_foc_sensorless_f28069MLaunchPad_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


rtGetNaN.obj : $(START_DIR)/mcb_pmsm_foc_sensorless_f28069MLaunchPad_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


rt_nonfinite.obj : $(START_DIR)/mcb_pmsm_foc_sensorless_f28069MLaunchPad_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"
