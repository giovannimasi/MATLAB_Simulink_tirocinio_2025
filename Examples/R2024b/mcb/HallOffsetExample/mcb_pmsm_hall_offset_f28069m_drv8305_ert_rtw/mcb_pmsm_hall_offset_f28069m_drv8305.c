 ...
 *
 * File: mcb_pmsm_hall_offset_f28069m_drv8305.c
 *
...
#include "mcb_pmsm_hall_offset_f28069m_drv8305.h"
#include "rtwtypes.h"
#include "mcb_pmsm_hall_offset_f28069m_drv8305_private.h"
#include <math.h>
...
BlockIO_mcb_pmsm_hall_offset_f2 mcb_pmsm_hall_offset_f28069m__B;
 ...
 *    '<S148>/Hall Value of 1'
 *    '<S147>/Hall Value of 2'
 */
...
/*
 * Output and update for action system:
 *    '<S148>/Hall Value of 2'
 *    '<S147>/Hall Value of 3'
 */
...
/*
 * Output and update for action system:
 *    '<S148>/Hall Value of 3'
 *    '<S147>/Hall Value of 4'
 */
void mcb_pmsm_hall_offs_HallValueof3(real32_T *rty_position)
{
  /* SignalConversion generated from: '<S160>/position' incorporates:
...
/*
 * Output and update for action system:
 *    '<S148>/Hall Value of 4'
 *    '<S147>/Hall Value of 5'
 */
...
/*
 * Output and update for action system:
 *    '<S148>/Hall Value of 5'
 *    '<S147>/Hall Value of 6'
 */
...
/*
 * Output and update for action system:
 *    '<S148>/Hall Value of 7'
 *    '<S147>/Hall Value of 1'
 *    '<S147>/Hall Value of 7'
 *    '<S136>/Hall Value of 7'
 */
...
/* Model step function */
void mcb_pmsm_hall_offset_f28069m_drv8305_step(void)
{
...
void mcb_pmsm_hall_offset_f28069m_drv8305_initialize(void)
{
  /* Registration code */
  ...
  /* block I/O */
  (void) memset(((void *) &mcb_pmsm_hall_offset_f28069m__B), 0,
                sizeof(BlockIO_mcb_pmsm_hall_offset_f2));

  {
    mcb_pmsm_hall_offset_f28069m__B.DataTypeConversion1 = 0.0F;
    mcb_pmsm_hall_offset_f28069m__B.Merge = 0.0F;
    mcb_pmsm_hall_offset_f28069m__B.Merge1 = 0.0F;
    mcb_pmsm_hall_offset_f28069m__B.Switch_m = 0.0F;
    mcb_pmsm_hall_offset_f28069m__B.Merge_l = 0.0F;
    mcb_pmsm_hall_offset_f28069m__B.indexing = 0.0F;
    mcb_pmsm_hall_offset_f28069m__B.Lookup[0] = 0.0F;
    mcb_pmsm_hall_offset_f28069m__B.Lookup[1] = 0.0F;
    mcb_pmsm_hall_offset_f28069m__B.Lookup[2] = 0.0F;
    mcb_pmsm_hall_offset_f28069m__B.Lookup[3] = 0.0F;
    mcb_pmsm_hall_offset_f28069m__B.Sum3 = 0.0F;
    mcb_pmsm_hall_offset_f28069m__B.DataTypeConversion1_p = 0.0F;
    mcb_pmsm_hall_offset_f28069m__B.Sum2 = 0.0F;
    mcb_pmsm_hall_offset_f28069m__B.Product = 0.0F;
    mcb_pmsm_hall_offset_f28069m__B.Sum4 = 0.0F;
    mcb_pmsm_hall_offset_f28069m__B.Sum5 = 0.0F;
    mcb_pmsm_hall_offset_f28069m__B.Product1 = 0.0F;
    mcb_pmsm_hall_offset_f28069m__B.Sum6 = 0.0F;
    mcb_pmsm_hall_offset_f28069m__B.currentSpeedData = 0.0F;
    mcb_pmsm_hall_offset_f28069m__B.Divide = 0.0F;
    mcb_pmsm_hall_offset_f28069m__B.SpeedGain = 0.0F;
    mcb_pmsm_hall_offset_f28069m__B.Merge1_f = 0.0F;
    mcb_pmsm_hall_offset_f28069m__B.Saturation = 0.0F;
    mcb_pmsm_hall_offset_f28069m__B.Merge_g = 0.0F;
    mcb_pmsm_hall_offset_f28069m__B.countData = 0.0F;
    mcb_pmsm_hall_offset_f28069m__B.currentSpeedData_g = 0.0F;
    mcb_pmsm_hall_offset_f28069m__B.Divide_m = 0.0F;
    mcb_pmsm_hall_offset_f28069m__B.countData_a = 0.0F;
    mcb_pmsm_hall_offset_f28069m__B.previousSpeedData = 0.0F;
    mcb_pmsm_hall_offset_f28069m__B.Divide_mp = 0.0F;
    mcb_pmsm_hall_offset_f28069m__B.currentSpeedData_n = 0.0F;
    mcb_pmsm_hall_offset_f28069m__B.Divide1 = 0.0F;
    mcb_pmsm_hall_offset_f28069m__B.Sum_b = 0.0F;
    mcb_pmsm_hall_offset_f28069m__B.Gain1 = 0.0F;
    mcb_pmsm_hall_offset_f28069m__B.Sum1 = 0.0F;
    mcb_pmsm_hall_offset_f28069m__B.Product_c = 0.0F;
    mcb_pmsm_hall_offset_f28069m__B.Merge1_o = 0.0F;
    mcb_pmsm_hall_offset_f28069m__B.Merge1_m = 0.0F;
    mcb_pmsm_hall_offset_f28069m__B.sqrt3_by_two = 0.0F;
    mcb_pmsm_hall_offset_f28069m__B.one_by_two = 0.0F;
    mcb_pmsm_hall_offset_f28069m__B.add_c = 0.0F;
    mcb_pmsm_hall_offset_f28069m__B.add_b = 0.0F;
    mcb_pmsm_hall_offset_f28069m__B.Min_f = 0.0F;
    mcb_pmsm_hall_offset_f28069m__B.Max_l = 0.0F;
    mcb_pmsm_hall_offset_f28069m__B.Add = 0.0F;
    mcb_pmsm_hall_offset_f28069m__B.one_by_two_g = 0.0F;
    mcb_pmsm_hall_offset_f28069m__B.Add2 = 0.0F;
    mcb_pmsm_hall_offset_f28069m__B.Add1_j = 0.0F;
    mcb_pmsm_hall_offset_f28069m__B.Add3 = 0.0F;
    mcb_pmsm_hall_offset_f28069m__B.Gain[0] = 0.0F;
    mcb_pmsm_hall_offset_f28069m__B.Gain[1] = 0.0F;
    mcb_pmsm_hall_offset_f28069m__B.Gain[2] = 0.0F;
    mcb_pmsm_hall_offset_f28069m__B.Sum_j[0] = 0.0F;
    mcb_pmsm_hall_offset_f28069m__B.Sum_j[1] = 0.0F;
    mcb_pmsm_hall_offset_f28069m__B.Sum_j[2] = 0.0F;
    mcb_pmsm_hall_offset_f28069m__B.Gain_i[0] = 0.0F;
    mcb_pmsm_hall_offset_f28069m__B.Gain_i[1] = 0.0F;
    mcb_pmsm_hall_offset_f28069m__B.Gain_i[2] = 0.0F;
    mcb_pmsm_hall_offset_f28069m__B.Input = 0.0F;
    mcb_pmsm_hall_offset_f28069m__B.Convert_back = 0.0F;
    mcb_pmsm_hall_offset_f28069m__B.Convert_back_c = 0.0F;
    mcb_pmsm_hall_offset_f28069m__B.Merge_o = 0.0F;
    mcb_pmsm_hall_offset_f28069m__B.UnitDelay = 0.0F;
    mcb_pmsm_hall_offset_f28069m__B.scaleOut = 0.0F;
    mcb_pmsm_hall_offset_f28069m__B.Add_e = 0.0F;
    mcb_pmsm_hall_offset_f28069m__B.DataTypeConversion1_d = 0.0F;
    mcb_pmsm_hall_offset_f28069m__B.Add1_m = 0.0F;
    mcb_pmsm_hall_offset_f28069m__B.Input_d = 0.0F;
    mcb_pmsm_hall_offset_f28069m__B.Delay_b = 0.0F;
    mcb_pmsm_hall_offset_f28069m__B.Add1_d = 0.0F;
    mcb_pmsm_hall_offset_f28069m__B.SaturatetomotorcalibSpeedRPM = 0.0F;
    mcb_pmsm_hall_offset_f28069m__B.qcos = 0.0F;
    mcb_pmsm_hall_offset_f28069m__B.dsin = 0.0F;
    mcb_pmsm_hall_offset_f28069m__B.sum_beta = 0.0F;
    mcb_pmsm_hall_offset_f28069m__B.dcos = 0.0F;
    mcb_pmsm_hall_offset_f28069m__B.qsin = 0.0F;
    mcb_pmsm_hall_offset_f28069m__B.sum_alpha = 0.0F;
    mcb_pmsm_hall_offset_f28069m__B.Switch_fs[0] = 0.0F;
    mcb_pmsm_hall_offset_f28069m__B.Switch_fs[1] = 0.0F;
    mcb_pmsm_hall_offset_f28069m__B.algDD_o1 = 0.0F;
    mcb_pmsm_hall_offset_f28069m__B.algDD_o2 = 0.0F;
    mcb_pmsm_hall_offset_f28069m__B.Delay_o = 0.0F;
    mcb_pmsm_hall_offset_f28069m__B.Switch1[0] = 0.0F;
    mcb_pmsm_hall_offset_f28069m__B.Switch1[1] = 0.0F;
    mcb_pmsm_hall_offset_f28069m__B.Product_l = 0.0F;
    mcb_pmsm_hall_offset_f28069m__B.UnitDelay_d = 0.0F;
    mcb_pmsm_hall_offset_f28069m__B.Product1_m = 0.0F;
    mcb_pmsm_hall_offset_f28069m__B.Add1_mi = 0.0F;
  }
  ...
  /* Start for Delay: '<S130>/validityDelay' */
  mcb_pmsm_hall_offset_f28069m__B.validityDelay = false;

  /* Start for Delay: '<S130>/speedCountDelay' */
  mcb_pmsm_hall_offset_f28069m__B.speedCountDelay = 0UL;

  /* Start for Delay: '<S131>/Delay One Step' */
  mcb_pmsm_hall_offset_f28069m__B.DelayOneStep = 0U;

  /* Start for S-Function (c2802xpwm): '<S77>/ePWM4' */
  ...
  /* Start for S-Function (c2802xpwm): '<S77>/ePWM5' */
  ...
  /* Start for S-Function (c2802xpwm): '<S77>/ePWM6' */
  ...
  /* Start for S-Function (c280xgpio_do): '<S77>/Inverter Enable' */
  EALLOW;
  ...
  /* InitializeConditions for Delay: '<S131>/Delay One Step1' */
  mcb_pmsm_hall_offset_f280_DWork.DelayOneStep1_DSTATE = true;

  /* InitializeConditions for Delay: '<S131>/Delay One Step' */
  mcb_pmsm_hall_offset_f280_DWork.DelayOneStep_DSTATE = 2500U;

  /* SystemInitialize for IfAction SubSystem: '<S129>/Speed and direction are valid Use speed to extrapolate position' */
  /* SystemInitialize for Enabled SubSystem: '<S133>/Subsystem1' */
  /* SystemInitialize for Merge: '<S146>/Merge' */
  mcb_pmsm_hall_offset_f28069m__B.Merge_g = 0.0F;

  /* End of SystemInitialize for SubSystem: '<S133>/Subsystem1' */
  /* End of SystemInitialize for SubSystem: '<S129>/Speed and direction are valid Use speed to extrapolate position' */
  ...
  mcb_pmsm_hall_o_ValidHalls_Init(&mcb_pmsm_hall_offset_f28069m__B.ValidHalls);
  ...
  mcb_pmsm_hall_o_ValidHalls_Init(&mcb_pmsm_hall_offset_f28069m__B.ValidHalls_j);
  ...
  mcb_pmsm_hall_o_ValidHalls_Init(&mcb_pmsm_hall_offset_f28069m__B.ValidHalls_a);
  ...
  /* Initialize out port */
  {
    mcb_pmsm_hall_offset_f28069m__B.SCIReceive = (uint16_T)0.0;
  }
...
void mcb_pmsm_hall_offset_f28069m_drv8305_terminate(void)
{
  ...
  if (1 == runModel) {
    {
      ...
      /* Output and update for function-call system: '<Root>/Offset Calculation' */
      {
        ...
        /* DataStoreRead: '<S128>/Data Store Read5' */
        mcb_pmsm_hall_offset_f28069m__B.DataStoreRead5 =
          mcb_pmsm_hall_offset_f280_DWork.HallStateChangeFlag;

        /* Switch: '<S129>/Switch' incorporates:
         *  Constant: '<S129>/WatchDog'
         */
        mcb_pmsm_hall_offset_f28069m__B.Switch_i = 0U;
        ...
        mcb_pmsm_hall_offset_f28069m__B.DataStoreRead_n =
          mcb_pmsm_hall_offset_f280_DWork.GlobalHallState;

        /* DataStoreRead: '<S128>/Data Store Read2' */
        mcb_pmsm_hall_offset_f28069m__B.DataStoreRead2 =
          mcb_pmsm_hall_offset_f280_DWork.GlobalSpeedCount;

        /* DataStoreRead: '<S128>/Data Store Read3' */
        mcb_pmsm_hall_offset_f28069m__B.DataStoreRead3 =
          mcb_pmsm_hall_offset_f280_DWork.GlobalDirection;

        /* DataStoreRead: '<S128>/Data Store Read4' */
        mcb_pmsm_hall_offset_f28069m__B.DataStoreRead4 =
          mcb_pmsm_hall_offset_f280_DWork.GlobalSpeedValidity;

        /* DataTypeConversion: '<S129>/Data Type Conversion4' */
        mcb_pmsm_hall_offset_f28069m__B.DataTypeConversion4 =
          (mcb_pmsm_hall_offset_f28069m__B.DataStoreRead5 != 0U);

        /* DataTypeConversion: '<S130>/Data Type Conversion' */
        mcb_pmsm_hall_offset_f28069m__B.DataTypeConversion_k =
          (mcb_pmsm_hall_offset_f28069m__B.DataStoreRead4 != 0U);

        /* Switch: '<S130>/Switch' incorporates:
         *  Constant: '<S130>/Order'
         */
        mcb_pmsm_hall_offset_f28069m__B.Switch_o = 0U;

        /* S-Function (memorycopy): '<S128>/Memory Copy3' */
        {
          uint32_T *memindsrc1 = (uint32_T *) (&ECap1Regs.TSCTR);
          uint32_T *meminddst1 = (uint32_T *)
            (&mcb_pmsm_hall_offset_f28069m__B.MemoryCopy3);
          *(uint32_T *) (meminddst1) = *(uint32_T *) (memindsrc1);
        }

        /* S-Function (memorycopy): '<S128>/Memory Copy4' */
        {
          uint32_T *memindsrc2 = (uint32_T *) (&ECap2Regs.TSCTR);
          uint32_T *meminddst2 = (uint32_T *)
            (&mcb_pmsm_hall_offset_f28069m__B.MemoryCopy4);
          *(uint32_T *) (meminddst2) = *(uint32_T *) (memindsrc2);
        }

        /* S-Function (memorycopy): '<S128>/Memory Copy5' */
        {
          uint32_T *memindsrc3 = (uint32_T *) (&ECap3Regs.TSCTR);
          uint32_T *meminddst3 = (uint32_T *)
            (&mcb_pmsm_hall_offset_f28069m__B.MemoryCopy5);
          *(uint32_T *) (meminddst3) = *(uint32_T *) (memindsrc3);
        }

        /* MinMax: '<S128>/Min' */
        u0 = mcb_pmsm_hall_offset_f28069m__B.MemoryCopy3;
        u1 = mcb_pmsm_hall_offset_f28069m__B.MemoryCopy4;
        if (u0 <= u1) {
          u1 = u0;
        }

        u0 = mcb_pmsm_hall_offset_f28069m__B.MemoryCopy5;
        if (u1 > u0) {
          u1 = u0;
        }

        /* MinMax: '<S128>/Min' */
        mcb_pmsm_hall_offset_f28069m__B.Min = u1;

        /* Delay: '<S131>/Delay One Step1' */
        mcb_pmsm_hall_offset_f28069m__B.DelayOneStep1 =
          mcb_pmsm_hall_offset_f280_DWork.DelayOneStep1_DSTATE;

        /* Logic: '<S131>/OR' */
        mcb_pmsm_hall_offset_f28069m__B.OR =
          (mcb_pmsm_hall_offset_f28069m__B.DelayOneStep1 ||
           mcb_pmsm_hall_offset_f28069m__B.DataTypeConversion4);

        /* Delay: '<S131>/Delay One Step' */
        doReset = mcb_pmsm_hall_offset_f28069m__B.DataTypeConversion4;
        if (mcb_pmsm_hall_offset_f28069m__B.OR) {
          if (doReset) {
            mcb_pmsm_hall_offset_f280_DWork.DelayOneStep_DSTATE = 2500U;
          }

          /* Delay: '<S131>/Delay One Step' */
          mcb_pmsm_hall_offset_f28069m__B.DelayOneStep =
            mcb_pmsm_hall_offset_f280_DWork.DelayOneStep_DSTATE;
        }

        /* End of Delay: '<S131>/Delay One Step' */

        /* RelationalOperator: '<S135>/Compare' incorporates:
         *  Constant: '<S135>/Constant'
         */
        mcb_pmsm_hall_offset_f28069m__B.Compare =
          (mcb_pmsm_hall_offset_f28069m__B.DelayOneStep > 0U);

        /* Switch: '<S134>/watchdog check' */
        if (mcb_pmsm_hall_offset_f28069m__B.Compare) {
          /* MinMax: '<S134>/Max' */
          u0 = mcb_pmsm_hall_offset_f28069m__B.DataStoreRead2;
          u1 = mcb_pmsm_hall_offset_f28069m__B.Min;
          if (u0 >= u1) {
            u1 = u0;
          }

          /* MinMax: '<S134>/Max' */
          mcb_pmsm_hall_offset_f28069m__B.Max = u1;

          /* Switch: '<S134>/speed check' */
          if (mcb_pmsm_hall_offset_f28069m__B.Max >= 33750000UL) {
            /* Switch: '<S134>/speed check' incorporates:
             *  Constant: '<S134>/Constant'
             */
            mcb_pmsm_hall_offset_f28069m__B.speedcheck = 0U;
          } else {
            /* Logic: '<S130>/Logical Operator' */
            mcb_pmsm_hall_offset_f28069m__B.LogicalOperator =
              (mcb_pmsm_hall_offset_f28069m__B.DataTypeConversion_k ||
               mcb_pmsm_hall_offset_f28069m__B.validityDelay);

            /* Switch: '<S134>/speed check' */
            mcb_pmsm_hall_offset_f28069m__B.speedcheck =
              mcb_pmsm_hall_offset_f28069m__B.LogicalOperator;
          }

          /* End of Switch: '<S134>/speed check' */

          /* Switch: '<S134>/watchdog check' */
          mcb_pmsm_hall_offset_f28069m__B.watchdogcheck =
            mcb_pmsm_hall_offset_f28069m__B.speedcheck;
        } else {
          /* Switch: '<S134>/watchdog check' incorporates:
           *  Constant: '<S134>/Constant'
           */
          mcb_pmsm_hall_offset_f28069m__B.watchdogcheck = 0U;
        }

        /* End of Switch: '<S134>/watchdog check' */

        /* If: '<S129>/If' */
        if (mcb_pmsm_hall_offset_f28069m__B.watchdogcheck != 0U) {
          /* Outputs for IfAction SubSystem: '<S129>/Speed and direction are valid Use speed to extrapolate position' incorporates:
           *  ActionPort: '<S133>/Action Port'
           */
          /* DataTypeConversion: '<S133>/currentSpeedData' */
          mcb_pmsm_hall_offset_f28069m__B.currentSpeedData = (real32_T)
            mcb_pmsm_hall_offset_f28069m__B.DataStoreRead2;

          /* Product: '<S133>/Divide' */
          mcb_pmsm_hall_offset_f28069m__B.Divide = 3.375E+7F /
            mcb_pmsm_hall_offset_f28069m__B.currentSpeedData;

          /* Gain: '<S133>/SpeedGain' */
          mcb_pmsm_hall_offset_f28069m__B.SpeedGain = 0.00333333341F *
            mcb_pmsm_hall_offset_f28069m__B.Divide;

          /* If: '<S133>/If' */
          if (mcb_pmsm_hall_offset_f28069m__B.DataStoreRead3 > 0) {
             ...
             */
            mcb_pmsm_hall_offset_f28069m__B.Merge =
              mcb_pmsm_hall_offset_f28069m__B.SpeedGain;
          ...
          /* Outputs for Enabled SubSystem: '<S133>/Subsystem1' incorporates:
           *  EnablePort: '<S146>/Enable'
           */
          /* Outputs for IfAction SubSystem: '<S146>/first_order' incorporates:
           *  ActionPort: '<S149>/Action Port'
           */
          /* If: '<S146>/If1' incorporates:
           *  DataTypeConversion: '<S149>/countData'
           *  DataTypeConversion: '<S149>/currentSpeedData'
           *  Gain: '<S149>/Gain'
           *  Merge: '<S146>/Merge1'
           *  Product: '<S149>/Divide'
           */
          mcb_pmsm_hall_offset_f28069m__B.countData = (real32_T)
            mcb_pmsm_hall_offset_f28069m__B.Min;
          mcb_pmsm_hall_offset_f28069m__B.currentSpeedData_g = (real32_T)
            mcb_pmsm_hall_offset_f28069m__B.DataStoreRead2;
          mcb_pmsm_hall_offset_f28069m__B.Divide_m =
            mcb_pmsm_hall_offset_f28069m__B.countData /
            mcb_pmsm_hall_offset_f28069m__B.currentSpeedData_g;
          mcb_pmsm_hall_offset_f28069m__B.Merge1_f = 0.5F *
            mcb_pmsm_hall_offset_f28069m__B.Divide_m;

          /* End of Outputs for SubSystem: '<S146>/first_order' */

          /* Saturate: '<S146>/Saturation' */
          u0_p = mcb_pmsm_hall_offset_f28069m__B.Merge1_f;
          if (u0_p > 0.16667F) {
            /* Saturate: '<S146>/Saturation' */
            mcb_pmsm_hall_offset_f28069m__B.Saturation = 0.16667F;
          } else {
            /* Saturate: '<S146>/Saturation' */
            mcb_pmsm_hall_offset_f28069m__B.Saturation = u0_p;
          }

          /* End of Saturate: '<S146>/Saturation' */

          /* If: '<S146>/If' */
          if (mcb_pmsm_hall_offset_f28069m__B.DataStoreRead3 != 1) {
            /* Outputs for IfAction SubSystem: '<S146>/-ve Direction' incorporates:
             *  ActionPort: '<S148>/Action Port'
             */
            /* SwitchCase: '<S148>/Switch Case' */
            switch ((int32_T)mcb_pmsm_hall_offset_f28069m__B.DataStoreRead_n) {
             case 5L:
              /* Outputs for IfAction SubSystem: '<S148>/Hall Value of 1' incorporates:
               *  ActionPort: '<S158>/Action Port'
               */
              mcb_pmsm_hall_offs_HallValueof1
                (&mcb_pmsm_hall_offset_f28069m__B.Merge1_m);

              /* End of Outputs for SubSystem: '<S148>/Hall Value of 1' */
              break;

             case 4L:
              /* Outputs for IfAction SubSystem: '<S148>/Hall Value of 2' incorporates:
               *  ActionPort: '<S159>/Action Port'
               */
              mcb_pmsm_hall_offs_HallValueof2
                (&mcb_pmsm_hall_offset_f28069m__B.Merge1_m);

              /* End of Outputs for SubSystem: '<S148>/Hall Value of 2' */
              break;

             case 6L:
              /* Outputs for IfAction SubSystem: '<S148>/Hall Value of 3' incorporates:
               *  ActionPort: '<S160>/Action Port'
               */
              mcb_pmsm_hall_offs_HallValueof3
                (&mcb_pmsm_hall_offset_f28069m__B.Merge1_m);

              /* End of Outputs for SubSystem: '<S148>/Hall Value of 3' */
              break;

             case 2L:
              /* Outputs for IfAction SubSystem: '<S148>/Hall Value of 4' incorporates:
               *  ActionPort: '<S161>/Action Port'
               */
              mcb_pmsm_hall_offs_HallValueof4
                (&mcb_pmsm_hall_offset_f28069m__B.Merge1_m);

              /* End of Outputs for SubSystem: '<S148>/Hall Value of 4' */
              break;

             case 3L:
              /* Outputs for IfAction SubSystem: '<S148>/Hall Value of 5' incorporates:
               *  ActionPort: '<S162>/Action Port'
               */
              mcb_pmsm_hall_offs_HallValueof5
                (&mcb_pmsm_hall_offset_f28069m__B.Merge1_m);

              /* End of Outputs for SubSystem: '<S148>/Hall Value of 5' */
              break;

             case 1L:
              /* Outputs for IfAction SubSystem: '<S148>/Hall Value of 6' incorporates:
               *  ActionPort: '<S163>/Action Port'
               */
              /* Merge: '<S148>/Merge1' incorporates:
               *  Constant: '<S163>/Constant'
               *  SignalConversion generated from: '<S163>/position'
               */
              mcb_pmsm_hall_offset_f28069m__B.Merge1_m = 1.0F;

              /* End of Outputs for SubSystem: '<S148>/Hall Value of 6' */
              break;

             default:
              /* Outputs for IfAction SubSystem: '<S148>/Hall Value of 7' incorporates:
               *  ActionPort: '<S164>/Action Port'
               */
              mcb_pmsm_hall_offs_HallValueof7
                (&mcb_pmsm_hall_offset_f28069m__B.Merge1_m);

              /* End of Outputs for SubSystem: '<S148>/Hall Value of 7' */
              break;
            }
             ...
             *  Sum: '<S148>/Sum'
             */
            mcb_pmsm_hall_offset_f28069m__B.Merge_g =
              mcb_pmsm_hall_offset_f28069m__B.Merge1_m -
              mcb_pmsm_hall_offset_f28069m__B.Saturation;

            /* End of Outputs for SubSystem: '<S146>/-ve Direction' */
          } else {
            /* Outputs for IfAction SubSystem: '<S146>/+ve Direction' incorporates:
             *  ActionPort: '<S147>/Action Port'
             */
            /* SwitchCase: '<S147>/Switch Case' */
            switch ((int32_T)mcb_pmsm_hall_offset_f28069m__B.DataStoreRead_n) {
             case 5L:
              /* Outputs for IfAction SubSystem: '<S147>/Hall Value of 1' incorporates:
               *  ActionPort: '<S151>/Action Port'
               */
              mcb_pmsm_hall_offs_HallValueof7
                (&mcb_pmsm_hall_offset_f28069m__B.Merge1_o);

              /* End of Outputs for SubSystem: '<S147>/Hall Value of 1' */
              break;

             case 4L:
              /* Outputs for IfAction SubSystem: '<S147>/Hall Value of 2' incorporates:
               *  ActionPort: '<S152>/Action Port'
               */
              mcb_pmsm_hall_offs_HallValueof1
                (&mcb_pmsm_hall_offset_f28069m__B.Merge1_o);

              /* End of Outputs for SubSystem: '<S147>/Hall Value of 2' */
              break;

             case 6L:
              /* Outputs for IfAction SubSystem: '<S147>/Hall Value of 3' incorporates:
               *  ActionPort: '<S153>/Action Port'
               */
              mcb_pmsm_hall_offs_HallValueof2
                (&mcb_pmsm_hall_offset_f28069m__B.Merge1_o);

              /* End of Outputs for SubSystem: '<S147>/Hall Value of 3' */
              break;

             case 2L:
              /* Outputs for IfAction SubSystem: '<S147>/Hall Value of 4' incorporates:
               *  ActionPort: '<S154>/Action Port'
               */
              mcb_pmsm_hall_offs_HallValueof3
                (&mcb_pmsm_hall_offset_f28069m__B.Merge1_o);

              /* End of Outputs for SubSystem: '<S147>/Hall Value of 4' */
              break;

             case 3L:
              /* Outputs for IfAction SubSystem: '<S147>/Hall Value of 5' incorporates:
               *  ActionPort: '<S155>/Action Port'
               */
              mcb_pmsm_hall_offs_HallValueof4
                (&mcb_pmsm_hall_offset_f28069m__B.Merge1_o);

              /* End of Outputs for SubSystem: '<S147>/Hall Value of 5' */
              break;

             case 1L:
              /* Outputs for IfAction SubSystem: '<S147>/Hall Value of 6' incorporates:
               *  ActionPort: '<S156>/Action Port'
               */
              mcb_pmsm_hall_offs_HallValueof5
                (&mcb_pmsm_hall_offset_f28069m__B.Merge1_o);

              /* End of Outputs for SubSystem: '<S147>/Hall Value of 6' */
              break;

             default:
              /* Outputs for IfAction SubSystem: '<S147>/Hall Value of 7' incorporates:
               *  ActionPort: '<S157>/Action Port'
               */
              mcb_pmsm_hall_offs_HallValueof7
                (&mcb_pmsm_hall_offset_f28069m__B.Merge1_o);

              /* End of Outputs for SubSystem: '<S147>/Hall Value of 7' */
              break;
            }
          ...
          /* End of If: '<S146>/If' */
          /* End of Outputs for SubSystem: '<S133>/Subsystem1' */

          /* Merge: '<S129>/Merge1' incorporates:
           *  SignalConversion generated from: '<S133>/rawPosition'
           */
          mcb_pmsm_hall_offset_f28069m__B.Merge1 =
            mcb_pmsm_hall_offset_f28069m__B.Merge_g;

          /* End of Outputs for SubSystem: '<S129>/Speed and direction are valid Use speed to extrapolate position' */
        } else {
          /* Outputs for IfAction SubSystem: '<S129>/Speed and direction are not valid Position will be set to the middle of the Hall quadrant' incorporates:
           *  ActionPort: '<S132>/Action Port'
           */
          /* SwitchCase: '<S136>/Switch Case' */
          switch ((int32_T)mcb_pmsm_hall_offset_f28069m__B.DataStoreRead_n) {
           case 5L:
            /* Outputs for IfAction SubSystem: '<S136>/Hall Value of 1' incorporates:
             ...
             */
            mcb_pmsm_hall_offset_f28069m__B.Merge1 = 0.083333F;

            /* End of Outputs for SubSystem: '<S136>/Hall Value of 1' */
            break;

           case 4L:
            /* Outputs for IfAction SubSystem: '<S136>/Hall Value of 2' incorporates:
             ...
             */
            mcb_pmsm_hall_offset_f28069m__B.Merge1 = 0.25F;

            /* End of Outputs for SubSystem: '<S136>/Hall Value of 2' */
            break;

           case 6L:
            /* Outputs for IfAction SubSystem: '<S136>/Hall Value of 3' incorporates:
             ...
             */
            mcb_pmsm_hall_offset_f28069m__B.Merge1 = 0.41667F;

            /* End of Outputs for SubSystem: '<S136>/Hall Value of 3' */
            break;

           case 2L:
            /* Outputs for IfAction SubSystem: '<S136>/Hall Value of 4' incorporates:
             *  ActionPort: '<S140>/Action Port'
             */
            /* Merge: '<S129>/Merge1' incorporates:
             *  Constant: '<S140>/Constant'
             *  SignalConversion generated from: '<S140>/position'
             */
            mcb_pmsm_hall_offset_f28069m__B.Merge1 = 0.58333F;

            /* End of Outputs for SubSystem: '<S136>/Hall Value of 4' */
            break;

           case 3L:
            /* Outputs for IfAction SubSystem: '<S136>/Hall Value of 5' incorporates:
             ...
             */
            mcb_pmsm_hall_offset_f28069m__B.Merge1 = 0.75F;

            /* End of Outputs for SubSystem: '<S136>/Hall Value of 5' */
            break;

           case 1L:
            /* Outputs for IfAction SubSystem: '<S136>/Hall Value of 6' incorporates:
             ...
             */
            mcb_pmsm_hall_offset_f28069m__B.Merge1 = 0.91667F;

            /* End of Outputs for SubSystem: '<S136>/Hall Value of 6' */
            break;

           default:
            /* Outputs for IfAction SubSystem: '<S136>/Hall Value of 7' incorporates:
             *  ActionPort: '<S143>/Action Port'
             */
            mcb_pmsm_hall_offs_HallValueof7
              (&mcb_pmsm_hall_offset_f28069m__B.Merge1);

            /* End of Outputs for SubSystem: '<S136>/Hall Value of 7' */
            break;
          }
           ...
           *  SignalConversion generated from: '<S132>/Speed(r.p.m)'
           */
          mcb_pmsm_hall_offset_f28069m__B.Merge = 0.0F;

          /* End of Outputs for SubSystem: '<S129>/Speed and direction are not valid Position will be set to the middle of the Hall quadrant' */
        }
         ...
         */
        mcb_pmsm_hall_offset_f28069m__B.Sum_a =
          mcb_pmsm_hall_offset_f28069m__B.DelayOneStep - 1U;

        /* UnitDelay: '<S120>/Output' */
        mcb_pmsm_hall_offset_f28069m__B.Output =
          mcb_pmsm_hall_offset_f280_DWork.Output_DSTATE;

        /* DataStoreRead: '<S74>/Data Store Read' */
        mcb_pmsm_hall_offset_f28069m__B.DataStoreRead_c =
          mcb_pmsm_hall_offset_f280_DWork.Enable;

        /* Outputs for Enabled SubSystem: '<S74>/PosGen' incorporates:
         *  EnablePort: '<S82>/Enable'
         */
        if (mcb_pmsm_hall_offset_f28069m__B.DataStoreRead_c) {
          ...
          /* Delay: '<S99>/Delay' */
          mcb_pmsm_hall_offset_f28069m__B.Delay =
            mcb_pmsm_hall_offset_f280_DWork.Delay_DSTATE_pm;

          /* Sum: '<S99>/Add1' */
          uLong2MultiWord(mcb_pmsm_hall_offset_f28069m__B.Delay, &tmp_p.chunks
                          [0U], 2);
          MultiWordAdd(&tmp_e.chunks[0U], &tmp_p.chunks[0U], &tmp.chunks[0U], 2);

          /* Sum: '<S99>/Add1' */
          mcb_pmsm_hall_offset_f28069m__B.Add1 = uMultiWord2uLongSat
            (&tmp.chunks[0U], 2);

          /* Update for Delay: '<S99>/Delay' */
          mcb_pmsm_hall_offset_f280_DWork.Delay_DSTATE_pm =
            mcb_pmsm_hall_offset_f28069m__B.Add1;
           ...
           */
          mcb_pmsm_hall_offset_f28069m__B.Compare_a =
            (mcb_pmsm_hall_offset_f28069m__B.Add1 <= 440000UL);

          /* Logic: '<S82>/NOT' */
          mcb_pmsm_hall_offset_f28069m__B.NOT_k =
            !mcb_pmsm_hall_offset_f28069m__B.Compare_a;

          /* Outputs for Enabled SubSystem: '<S82>/Subsystem' incorporates:
           *  EnablePort: '<S97>/Enable'
           */
          if (mcb_pmsm_hall_offset_f28069m__B.NOT_k) {
           ...
           */
          mcb_pmsm_hall_offset_f28069m__B.Compare_i =
            (mcb_pmsm_hall_offset_f28069m__B.Add1 <= 400000UL);

          /* If: '<S98>/If' incorporates:
           *  Constant: '<S98>/Count for 2 sec'
           */
          if (mcb_pmsm_hall_offset_f28069m__B.Add1 < 50000UL) {
             ...
             */
            /* Delay: '<S101>/Delay' */
            mcb_pmsm_hall_offset_f28069m__B.Delay_b =
              mcb_pmsm_hall_offset_f280_DWork.Delay_DSTATE;

            /* Sum: '<S101>/Add1' incorporates:
             *  Constant: '<S101>/Constant1'
             */
            mcb_pmsm_hall_offset_f28069m__B.Add1_d =
              mcb_pmsm_hall_offset_f28069m__B.Delay_b + 0.001F;

            /* Saturate: '<S101>/Saturate to 'motor.calibSpeed' RPM' */
            u0_p = mcb_pmsm_hall_offset_f28069m__B.Add1_d;
            if (u0_p > 4.0F) {
              /* Saturate: '<S101>/Saturate to 'motor.calibSpeed' RPM' */
              mcb_pmsm_hall_offset_f28069m__B.SaturatetomotorcalibSpeedRPM =
                4.0F;
            } else if (u0_p < 0.0F) {
              /* Saturate: '<S101>/Saturate to 'motor.calibSpeed' RPM' */
              mcb_pmsm_hall_offset_f28069m__B.SaturatetomotorcalibSpeedRPM =
             ...
             *  Gain: '<S101>/Multiply'
             */
            mcb_pmsm_hall_offset_f28069m__B.Merge_o = 5.0E-5F *
              mcb_pmsm_hall_offset_f28069m__B.SaturatetomotorcalibSpeedRPM;
           ...
           */
          if (mcb_pmsm_hall_offset_f28069m__B.Delay_c) {
            /* SignalConversion generated from: '<S104>/Input' */
            mcb_pmsm_hall_offset_f28069m__B.Input_d =
              mcb_pmsm_hall_offset_f28069m__B.Merge_o;
          }

          /* End of Outputs for SubSystem: '<S103>/Subsystem' */

          /* Sum: '<S103>/Add' */
          mcb_pmsm_hall_offset_f28069m__B.Add_e =
            mcb_pmsm_hall_offset_f28069m__B.Input_d +
            mcb_pmsm_hall_offset_f28069m__B.UnitDelay;

          /* DataTypeConversion: '<S103>/Data Type Conversion' */
          mcb_pmsm_hall_offset_f28069m__B.DataTypeConversion_c = (int16_T)
            (real32_T)floor(mcb_pmsm_hall_offset_f28069m__B.Add_e);

          /* DataTypeConversion: '<S103>/Data Type Conversion1' */
          mcb_pmsm_hall_offset_f28069m__B.DataTypeConversion1_d =
            mcb_pmsm_hall_offset_f28069m__B.DataTypeConversion_c;

          /* Sum: '<S103>/Add1' */
          mcb_pmsm_hall_offset_f28069m__B.Add1_m =
            mcb_pmsm_hall_offset_f28069m__B.Add_e -
            mcb_pmsm_hall_offset_f28069m__B.DataTypeConversion1_d;
          ...
          /* Gain: '<S102>/scaleOut' */
          mcb_pmsm_hall_offset_f28069m__B.scaleOut =
            mcb_pmsm_hall_offset_f28069m__B.Add1_m;
          ...
          if (mcb_pmsm_hall_offset_f280_DWork.UpCounter_MODE) {
             ...
             *  Outport: '<S99>/Count'
             */
            mcb_pmsm_hall_offset_f28069m__B.Add1 = 0UL;
           ...
           *  Outport: '<S82>/EnPWM'
           */
          mcb_pmsm_hall_offset_f28069m__B.Compare_i = false;

          /* Disable for RelationalOperator: '<S95>/Compare' incorporates:
           *  Outport: '<S82>/EnableHost'
           */
          mcb_pmsm_hall_offset_f28069m__B.Compare_a = false;
        ...
        /* Switch: '<S6>/Switch' */
        if (mcb_pmsm_hall_offset_f28069m__B.Compare_a) {
          /* Switch: '<S6>/Switch' */
          mcb_pmsm_hall_offset_f28069m__B.Switch_m =
            mcb_pmsm_hall_offset_f28069m__B.Merge1;
        } else {
          /* Switch: '<S6>/Switch' incorporates:
           *  Constant: '<S6>/Constant'
           */
          mcb_pmsm_hall_offset_f28069m__B.Switch_m = -1.0F;
        }
         ...
         */
        if (mcb_pmsm_hall_offset_f28069m__B.Compare_i) {
           ...
           */
          mcb_pmsm_hall_offset_f28069m__B.Compare_au =
            (mcb_pmsm_hall_offset_f28069m__B.scaleOut <= 0.01F);

          /* Delay: '<S80>/Delay' */
          mcb_pmsm_hall_offset_f28069m__B.Delay_o =
            mcb_pmsm_hall_offset_f280_DWork.Delay_DSTATE_p;

          /* RelationalOperator: '<S87>/Compare' incorporates:
           *  Constant: '<S87>/Constant'
           */
          mcb_pmsm_hall_offset_f28069m__B.Compare_j =
            (mcb_pmsm_hall_offset_f28069m__B.Delay_o >= 0.99F);

          /* Logic: '<S80>/AND' */
          mcb_pmsm_hall_offset_f28069m__B.AND =
            (mcb_pmsm_hall_offset_f28069m__B.Compare_au &&
             mcb_pmsm_hall_offset_f28069m__B.Compare_j);
           ...
           */
          if (mcb_pmsm_hall_offset_f28069m__B.AND) {
            /* Switch: '<S89>/Switch1' incorporates:
             *  Constant: '<S89>/FilterConstant'
             *  Constant: '<S89>/OneMinusFilterConstant'
             */
            mcb_pmsm_hall_offset_f28069m__B.Switch1[0] = 0.5F;
            mcb_pmsm_hall_offset_f28069m__B.Switch1[1] = 0.5F;

            /* Product: '<S92>/Product' */
            mcb_pmsm_hall_offset_f28069m__B.Product_l =
              mcb_pmsm_hall_offset_f28069m__B.Merge1 * 0.5F;

            /* UnitDelay: '<S92>/Unit Delay' */
            mcb_pmsm_hall_offset_f28069m__B.UnitDelay_d =
              mcb_pmsm_hall_offset_f280_DWork.UnitDelay_DSTATE_f;

            /* Product: '<S92>/Product1' */
            mcb_pmsm_hall_offset_f28069m__B.Product1_m = 0.5F *
              mcb_pmsm_hall_offset_f28069m__B.UnitDelay_d;

            /* Sum: '<S92>/Add1' */
            mcb_pmsm_hall_offset_f28069m__B.Add1_mi =
              mcb_pmsm_hall_offset_f28069m__B.Product_l +
              mcb_pmsm_hall_offset_f28069m__B.Product1_m;
        ...
        mcb_pmsm_hall_offset_f28069m__B.DataTypeConversion1_m[0] = (int32_T)
          (mcb_pmsm_hall_offset_f28069m__B.Switch_m * 4096.0F);
        mcb_pmsm_hall_offset_f28069m__B.DataTypeConversion1_m[1] = (int32_T)
          (mcb_pmsm_hall_offset_f28069m__B.Input * 4096.0F);

        /* DataTypeConversion: '<S122>/Data Type Conversion3' incorporates:
         *  DataTypeConversion: '<S122>/Data Type Conversion1'
         */
        mcb_pmsm_hall_offset_f28069m__B.DataTypeConversion3[0] = (uint16_T)
          mcb_pmsm_hall_offset_f28069m__B.DataTypeConversion1_m[0];
        mcb_pmsm_hall_offset_f28069m__B.DataTypeConversion3[1] = (uint16_T)
          mcb_pmsm_hall_offset_f28069m__B.DataTypeConversion1_m[1];

        /* If: '<S75>/If' */
        if (mcb_pmsm_hall_offset_f28069m__B.Output == 0U) {
           ...
           */
          mcb_pmsm_hall_offset_f28069m__B.Merge_ol[0] = 21331U;

          /* SignalConversion generated from: '<S124>/Data' */
          Data = mcb_pmsm_hall_offset_f28069m__B.DataTypeConversion3[0];

          /* End of Outputs for SubSystem: '<S75>/Start' */
          mcb_pmsm_hall_offset_f28069m__B.Data_fw[0] = Data;
           ...
           *  SignalConversion generated from: '<S124>/Data_out'
           */
          mcb_pmsm_hall_offset_f28069m__B.Merge_ol[1] = Data;

          /* SignalConversion generated from: '<S124>/Data' */
          Data = mcb_pmsm_hall_offset_f28069m__B.DataTypeConversion3[1];

          /* End of Outputs for SubSystem: '<S75>/Start' */
          mcb_pmsm_hall_offset_f28069m__B.Data_fw[1] = Data;
           ...
           *  SignalConversion generated from: '<S124>/Data_out'
           */
          mcb_pmsm_hall_offset_f28069m__B.Merge_ol[2] = Data;

          /* Merge: '<S75>/Merge1' incorporates:
           *  Bias: '<S124>/Bias'
           */
          mcb_pmsm_hall_offset_f28069m__B.Merge1_b = 3U;

          /* End of Outputs for SubSystem: '<S75>/Start' */
        } else if (mcb_pmsm_hall_offset_f28069m__B.Output == 599U) {
          /* Outputs for IfAction SubSystem: '<S75>/End' incorporates:
           *  ActionPort: '<S123>/Action Port'
           */
          /* SignalConversion generated from: '<S123>/Data' */
          Data = mcb_pmsm_hall_offset_f28069m__B.DataTypeConversion3[0];

          /* End of Outputs for SubSystem: '<S75>/End' */
          mcb_pmsm_hall_offset_f28069m__B.Data_f[0] = Data;

          /* Outputs for IfAction SubSystem: '<S75>/End' incorporates:
           *  ActionPort: '<S123>/Action Port'
           */
          /* Merge: '<S75>/Merge' incorporates:
           *  SignalConversion generated from: '<S123>/Data_out'
           */
          mcb_pmsm_hall_offset_f28069m__B.Merge_ol[0] = Data;

          /* SignalConversion generated from: '<S123>/Data' */
          Data = mcb_pmsm_hall_offset_f28069m__B.DataTypeConversion3[1];

          /* End of Outputs for SubSystem: '<S75>/End' */
          mcb_pmsm_hall_offset_f28069m__B.Data_f[1] = Data;
           ...
           */
          mcb_pmsm_hall_offset_f28069m__B.Merge_ol[1] = Data;
          mcb_pmsm_hall_offset_f28069m__B.Merge_ol[2] = 17733U;
          ...
          mcb_pmsm_hall_offset_f28069m__B.Data[0] = Data;
          ...
          /* End of Outputs for SubSystem: '<S75>/Data' */
          mcb_pmsm_hall_offset_f28069m__B.Data[1] = Data;
           ...
           */
          mcb_pmsm_hall_offset_f28069m__B.Merge_ol[1] = Data;
          mcb_pmsm_hall_offset_f28069m__B.Merge_ol[2] = 0U;

          /* Merge: '<S75>/Merge1' incorporates:
           *  SignalConversion generated from: '<S121>/Data_width'
           */
          mcb_pmsm_hall_offset_f28069m__B.Merge1_b = 2U;
         ...
         *  WhileIterator: '<S125>/While Iterator'
         */
        s125_iter = 1;
        do {
          mcb_pmsm_hall_offset_f28069m__B.WhileIterator = s125_iter;
          mcb_pmsm_hall_offset_f28069m__B.IndexVector =
            mcb_pmsm_hall_offset_f28069m__B.Merge_ol[mcb_pmsm_hall_offset_f28069m__B.WhileIterator
            - 1];

          {
            if (checkSCITransmitInProgressA != 1U) {
              ...
              errFlgData = scia_xmit((uchar_T*)
                &mcb_pmsm_hall_offset_f28069m__B.IndexVector, 2, 2);
              checkSCITransmitInProgressA = 0U;
            }
          }

          mcb_pmsm_hall_offset_f28069m__B.Add_d =
            mcb_pmsm_hall_offset_f28069m__B.Merge1_b - (uint16_T)
            mcb_pmsm_hall_offset_f28069m__B.WhileIterator;
          s125_iter++;
        } while (mcb_pmsm_hall_offset_f28069m__B.Add_d != 0U);

        /* End of Outputs for SubSystem: '<S75>/While Iterator Subsystem' */

        /* Sum: '<S126>/FixPt Sum1' incorporates:
         *  Constant: '<S126>/FixPt Constant'
         */
        mcb_pmsm_hall_offset_f28069m__B.FixPtSum1 =
          mcb_pmsm_hall_offset_f28069m__B.Output + 1U;

        /* Switch: '<S127>/FixPt Switch' */
        if (mcb_pmsm_hall_offset_f28069m__B.FixPtSum1 > 599U) {
          /* Switch: '<S127>/FixPt Switch' incorporates:
           *  Constant: '<S127>/Constant'
           */
          mcb_pmsm_hall_offset_f28069m__B.FixPtSwitch = 0U;
        } else {
          /* Switch: '<S127>/FixPt Switch' */
          mcb_pmsm_hall_offset_f28069m__B.FixPtSwitch =
            mcb_pmsm_hall_offset_f28069m__B.FixPtSum1;
        }

        /* End of Switch: '<S127>/FixPt Switch' */

        /* RelationalOperator: '<S109>/Compare' incorporates:
         *  Constant: '<S109>/Constant'
         */
        mcb_pmsm_hall_offset_f28069m__B.Compare_e =
          (mcb_pmsm_hall_offset_f28069m__B.scaleOut < 0.0F);

        /* DataTypeConversion: '<S107>/Data Type Conversion' */
        mcb_pmsm_hall_offset_f28069m__B.DataTypeConversion_g =
          mcb_pmsm_hall_offset_f28069m__B.Compare_e;

        /* If: '<S107>/If' */
        if (mcb_pmsm_hall_offset_f28069m__B.DataTypeConversion_g > 0U) {
          /* Outputs for IfAction SubSystem: '<S107>/If Action Subsystem' incorporates:
           *  ActionPort: '<S110>/Action Port'
           */
          /* DataTypeConversion: '<S110>/Convert_uint16' */
          mcb_pmsm_hall_offset_f28069m__B.Convert_uint16_k = (int16_T)(real32_T)
            floor(mcb_pmsm_hall_offset_f28069m__B.scaleOut);

          /* DataTypeConversion: '<S110>/Convert_back' */
          mcb_pmsm_hall_offset_f28069m__B.Convert_back_c =
            mcb_pmsm_hall_offset_f28069m__B.Convert_uint16_k;

          /* Merge: '<S107>/Merge' incorporates:
           *  Sum: '<S110>/Sum'
           */
          mcb_pmsm_hall_offset_f28069m__B.Merge_l =
            mcb_pmsm_hall_offset_f28069m__B.scaleOut -
            mcb_pmsm_hall_offset_f28069m__B.Convert_back_c;
          ...
          mcb_pmsm_hall_offset_f28069m__B.Convert_uint16 = (int16_T)
            mcb_pmsm_hall_offset_f28069m__B.scaleOut;

          /* DataTypeConversion: '<S111>/Convert_back' */
          mcb_pmsm_hall_offset_f28069m__B.Convert_back =
            mcb_pmsm_hall_offset_f28069m__B.Convert_uint16;
        ...
        /* Gain: '<S105>/indexing' */
        mcb_pmsm_hall_offset_f28069m__B.indexing = 800.0F *
          mcb_pmsm_hall_offset_f28069m__B.Merge_l;

        /* DataTypeConversion: '<S105>/Get_Integer' */
        mcb_pmsm_hall_offset_f28069m__B.Get_Integer = (uint16_T)
          mcb_pmsm_hall_offset_f28069m__B.indexing;

        /* Sum: '<S105>/Sum' incorporates:
         *  Constant: '<S105>/offset'
         */
        u1 = mcb_pmsm_hall_offset_f28069m__B.Get_Integer + 1UL;
        mcb_pmsm_hall_offset_f28069m__B.Sum[0] = u1;

        /* Selector: '<S105>/Lookup' incorporates:
         *  Constant: '<S105>/sine_table_values'
         */
        mcb_pmsm_hall_offset_f28069m__B.Lookup[0] =
          mcb_pmsm_hall_offset_f28_ConstP.sine_table_values_Value[(int16_T)u1];

        /* Sum: '<S105>/Sum' */
        u1 = mcb_pmsm_hall_offset_f28069m__B.Get_Integer;
        mcb_pmsm_hall_offset_f28069m__B.Sum[1] = u1;

        /* Selector: '<S105>/Lookup' incorporates:
         *  Constant: '<S105>/sine_table_values'
         */
        mcb_pmsm_hall_offset_f28069m__B.Lookup[1] =
          mcb_pmsm_hall_offset_f28_ConstP.sine_table_values_Value[(int16_T)u1];

        /* Sum: '<S105>/Sum' incorporates:
         *  Constant: '<S105>/offset'
         */
        u1 = mcb_pmsm_hall_offset_f28069m__B.Get_Integer + 201UL;
        mcb_pmsm_hall_offset_f28069m__B.Sum[2] = u1;

        /* Selector: '<S105>/Lookup' incorporates:
         *  Constant: '<S105>/sine_table_values'
         */
        mcb_pmsm_hall_offset_f28069m__B.Lookup[2] =
          mcb_pmsm_hall_offset_f28_ConstP.sine_table_values_Value[(int16_T)u1];

        /* Sum: '<S105>/Sum' incorporates:
         *  Constant: '<S105>/offset'
         */
        u1 = mcb_pmsm_hall_offset_f28069m__B.Get_Integer + 200UL;
        mcb_pmsm_hall_offset_f28069m__B.Sum[3] = u1;

        /* Selector: '<S105>/Lookup' incorporates:
         *  Constant: '<S105>/sine_table_values'
         */
        mcb_pmsm_hall_offset_f28069m__B.Lookup[3] =
          mcb_pmsm_hall_offset_f28_ConstP.sine_table_values_Value[(int16_T)u1];

        /* Sum: '<S106>/Sum3' */
        mcb_pmsm_hall_offset_f28069m__B.Sum3 =
          mcb_pmsm_hall_offset_f28069m__B.Lookup[0] -
          mcb_pmsm_hall_offset_f28069m__B.Lookup[1];

        /* DataTypeConversion: '<S105>/Data Type Conversion1' */
        mcb_pmsm_hall_offset_f28069m__B.DataTypeConversion1_p =
          mcb_pmsm_hall_offset_f28069m__B.Get_Integer;

        /* Sum: '<S105>/Sum2' */
        mcb_pmsm_hall_offset_f28069m__B.Sum2 =
          mcb_pmsm_hall_offset_f28069m__B.indexing -
          mcb_pmsm_hall_offset_f28069m__B.DataTypeConversion1_p;

        /* Product: '<S106>/Product' */
        mcb_pmsm_hall_offset_f28069m__B.Product =
          mcb_pmsm_hall_offset_f28069m__B.Sum3 *
          mcb_pmsm_hall_offset_f28069m__B.Sum2;

        /* Sum: '<S106>/Sum4' */
        mcb_pmsm_hall_offset_f28069m__B.Sum4 =
          mcb_pmsm_hall_offset_f28069m__B.Product +
          mcb_pmsm_hall_offset_f28069m__B.Lookup[1];

        /* Sum: '<S106>/Sum5' */
        mcb_pmsm_hall_offset_f28069m__B.Sum5 =
          mcb_pmsm_hall_offset_f28069m__B.Lookup[2] -
          mcb_pmsm_hall_offset_f28069m__B.Lookup[3];

        /* Product: '<S106>/Product1' */
        mcb_pmsm_hall_offset_f28069m__B.Product1 =
          mcb_pmsm_hall_offset_f28069m__B.Sum5 *
          mcb_pmsm_hall_offset_f28069m__B.Sum2;

        /* Sum: '<S106>/Sum6' */
        mcb_pmsm_hall_offset_f28069m__B.Sum6 =
          mcb_pmsm_hall_offset_f28069m__B.Product1 +
          mcb_pmsm_hall_offset_f28069m__B.Lookup[3];
         ...
         *  Constant: '<S74>/Vd_Ref'
         */
        mcb_pmsm_hall_offset_f28069m__B.dsin = 0.15F *
          mcb_pmsm_hall_offset_f28069m__B.Sum4;

        /* Sum: '<S93>/sum_beta' */
        mcb_pmsm_hall_offset_f28069m__B.sum_beta =
          mcb_pmsm_hall_offset_f28069m__B.qcos +
          mcb_pmsm_hall_offset_f28069m__B.dsin;

        /* Product: '<S93>/dcos' incorporates:
         *  Constant: '<S74>/Vd_Ref'
         */
        mcb_pmsm_hall_offset_f28069m__B.dcos = 0.15F *
          mcb_pmsm_hall_offset_f28069m__B.Sum6;
        ...
        /* Sum: '<S93>/sum_alpha' */
        mcb_pmsm_hall_offset_f28069m__B.sum_alpha =
          mcb_pmsm_hall_offset_f28069m__B.dcos -
          mcb_pmsm_hall_offset_f28069m__B.qsin;

        /* Switch: '<S94>/Switch' */
        mcb_pmsm_hall_offset_f28069m__B.Switch_fs[0] =
          mcb_pmsm_hall_offset_f28069m__B.sum_alpha;
        mcb_pmsm_hall_offset_f28069m__B.Switch_fs[1] =
          mcb_pmsm_hall_offset_f28069m__B.sum_beta;

        /* AlgorithmDescriptorDelegate generated from: '<S93>/a16' */
        mcb_pmsm_hall_offset_f28069m__B.algDD_o1 =
          mcb_pmsm_hall_offset_f28069m__B.Switch_fs[0];

        /* AlgorithmDescriptorDelegate generated from: '<S93>/a16' */
        mcb_pmsm_hall_offset_f28069m__B.algDD_o2 =
          mcb_pmsm_hall_offset_f28069m__B.Switch_fs[1];
        ...
        if (mcb_pmsm_hall_offset_f28069m__B.Compare_i) {
          ...
          mcb_pmsm_hall_offset_f28069m__B.sqrt3_by_two = 0.866025388F *
            mcb_pmsm_hall_offset_f28069m__B.algDD_o2;

          /* Gain: '<S119>/one_by_two' */
          mcb_pmsm_hall_offset_f28069m__B.one_by_two = 0.5F *
            mcb_pmsm_hall_offset_f28069m__B.algDD_o1;

          /* Sum: '<S119>/add_c' */
          mcb_pmsm_hall_offset_f28069m__B.add_c = (0.0F -
            mcb_pmsm_hall_offset_f28069m__B.one_by_two) -
            mcb_pmsm_hall_offset_f28069m__B.sqrt3_by_two;

          /* Sum: '<S119>/add_b' */
          mcb_pmsm_hall_offset_f28069m__B.add_b =
            mcb_pmsm_hall_offset_f28069m__B.sqrt3_by_two -
            mcb_pmsm_hall_offset_f28069m__B.one_by_two;

          /* MinMax: '<S116>/Min' */
          u0_p = mcb_pmsm_hall_offset_f28069m__B.algDD_o1;
          Bias = mcb_pmsm_hall_offset_f28069m__B.add_b;
          if ((u0_p <= Bias) || rtIsNaNF(Bias)) {
            Bias = u0_p;
          }

          u0_p = mcb_pmsm_hall_offset_f28069m__B.add_c;
          if ((!(Bias <= u0_p)) && (!rtIsNaNF(u0_p))) {
            Bias = u0_p;
          }

          /* MinMax: '<S116>/Min' */
          mcb_pmsm_hall_offset_f28069m__B.Min_f = Bias;
          ...
          /* MinMax: '<S116>/Max' */
          mcb_pmsm_hall_offset_f28069m__B.Max_l = Bias;

          /* Sum: '<S116>/Add' */
          mcb_pmsm_hall_offset_f28069m__B.Add =
            mcb_pmsm_hall_offset_f28069m__B.Max_l +
            mcb_pmsm_hall_offset_f28069m__B.Min_f;

          /* Gain: '<S116>/one_by_two' */
          mcb_pmsm_hall_offset_f28069m__B.one_by_two_g = -0.5F *
            mcb_pmsm_hall_offset_f28069m__B.Add;

          /* Sum: '<S115>/Add2' */
          mcb_pmsm_hall_offset_f28069m__B.Add2 =
            mcb_pmsm_hall_offset_f28069m__B.one_by_two_g +
            mcb_pmsm_hall_offset_f28069m__B.add_c;

          /* Sum: '<S115>/Add1' */
          mcb_pmsm_hall_offset_f28069m__B.Add1_j =
            mcb_pmsm_hall_offset_f28069m__B.add_b +
            mcb_pmsm_hall_offset_f28069m__B.one_by_two_g;

          /* Sum: '<S115>/Add3' */
          mcb_pmsm_hall_offset_f28069m__B.Add3 =
            mcb_pmsm_hall_offset_f28069m__B.algDD_o1 +
            mcb_pmsm_hall_offset_f28069m__B.one_by_two_g;

          /* Gain: '<S115>/Gain' */
          mcb_pmsm_hall_offset_f28069m__B.Gain[0] = 1.15470052F *
            mcb_pmsm_hall_offset_f28069m__B.Add3;
          mcb_pmsm_hall_offset_f28069m__B.Gain[1] = 1.15470052F *
            mcb_pmsm_hall_offset_f28069m__B.Add1_j;
          mcb_pmsm_hall_offset_f28069m__B.Gain[2] = 1.15470052F *
            mcb_pmsm_hall_offset_f28069m__B.Add2;

          /* Sum: '<S76>/Sum' incorporates:
           *  Constant: '<S76>/Constant'
           */
          Bias = mcb_pmsm_hall_offset_f28069m__B.Gain[0] + 1.0F;
          mcb_pmsm_hall_offset_f28069m__B.Sum_j[0] = Bias;

          /* Gain: '<S76>/Gain' */
          Bias *= 0.5F;
          mcb_pmsm_hall_offset_f28069m__B.Gain_i[0] = Bias;

          /* Gain: '<S76>/Scale_to_PWM_Counter_PRD' */
          Data = (uint16_T)(2250.0F * Bias);
          mcb_pmsm_hall_offset_f28069m__B.Scale_to_PWM_Counter_PRD[0] = Data;

          /* Switch: '<S76>/Switch4' */
          mcb_pmsm_hall_offset_f28069m__B.Switch4[0] = Data;

          /* Sum: '<S76>/Sum' incorporates:
           *  Constant: '<S76>/Constant'
           */
          Bias = mcb_pmsm_hall_offset_f28069m__B.Gain[1] + 1.0F;
          mcb_pmsm_hall_offset_f28069m__B.Sum_j[1] = Bias;

          /* Gain: '<S76>/Gain' */
          Bias *= 0.5F;
          mcb_pmsm_hall_offset_f28069m__B.Gain_i[1] = Bias;

          /* Gain: '<S76>/Scale_to_PWM_Counter_PRD' */
          Data = (uint16_T)(2250.0F * Bias);
          mcb_pmsm_hall_offset_f28069m__B.Scale_to_PWM_Counter_PRD[1] = Data;

          /* Switch: '<S76>/Switch4' */
          mcb_pmsm_hall_offset_f28069m__B.Switch4[1] = Data;

          /* Sum: '<S76>/Sum' incorporates:
           *  Constant: '<S76>/Constant'
           */
          Bias = mcb_pmsm_hall_offset_f28069m__B.Gain[2] + 1.0F;
          mcb_pmsm_hall_offset_f28069m__B.Sum_j[2] = Bias;

          /* Gain: '<S76>/Gain' */
          Bias *= 0.5F;
          mcb_pmsm_hall_offset_f28069m__B.Gain_i[2] = Bias;

          /* Gain: '<S76>/Scale_to_PWM_Counter_PRD' */
          Data = (uint16_T)(2250.0F * Bias);
          mcb_pmsm_hall_offset_f28069m__B.Scale_to_PWM_Counter_PRD[2] = Data;

          /* Switch: '<S76>/Switch4' */
          mcb_pmsm_hall_offset_f28069m__B.Switch4[2] = Data;
        } else {
          /* Switch: '<S76>/Switch4' incorporates:
           *  Constant: '<S76>/stop'
           */
          mcb_pmsm_hall_offset_f28069m__B.Switch4[0] = 0U;
          mcb_pmsm_hall_offset_f28069m__B.Switch4[1] = 0U;
          mcb_pmsm_hall_offset_f28069m__B.Switch4[2] = 0U;
        }

        /* End of Switch: '<S76>/Switch4' */

        /* S-Function (c2802xpwm): '<S77>/ePWM4' */
        uint16_T tbprdValue1Outputs = EPwm1Regs.TBPRD;

        /*-- Update CMPA value for ePWM1 --*/
        {
          EPwm1Regs.CMPA.half.CMPA = (uint16_T)
            (mcb_pmsm_hall_offset_f28069m__B.Switch4[0]);
        }

        /* S-Function (c2802xpwm): '<S77>/ePWM5' */
        uint16_T tbprdValue2Outputs = EPwm2Regs.TBPRD;

        /*-- Update CMPA value for ePWM2 --*/
        {
          EPwm2Regs.CMPA.half.CMPA = (uint16_T)
            (mcb_pmsm_hall_offset_f28069m__B.Switch4[1]);
        }

        /* S-Function (c2802xpwm): '<S77>/ePWM6' */
        uint16_T tbprdValue3Outputs = EPwm3Regs.TBPRD;

        /*-- Update CMPA value for ePWM3 --*/
        {
          EPwm3Regs.CMPA.half.CMPA = (uint16_T)
            (mcb_pmsm_hall_offset_f28069m__B.Switch4[2]);
        }

        /* Switch: '<S77>/Switch' */
        mcb_pmsm_hall_offset_f28069m__B.Switch_p =
          mcb_pmsm_hall_offset_f28069m__B.Compare_i;

        /* S-Function (c280xgpio_do): '<S77>/Inverter Enable' */
        {
          if (mcb_pmsm_hall_offset_f28069m__B.Switch_p) {
        ...
        /* S-Function (c2802xadc): '<S6>/IA//IB Measurement' */
        {
          ...
          mcb_pmsm_hall_offset_f28069m__B.IAIBMeasurement[0] =
            (AdcResult.ADCRESULT0);
          mcb_pmsm_hall_offset_f28069m__B.IAIBMeasurement[1] =
            (AdcResult.ADCRESULT1);
        }

        /* Update for Delay: '<S131>/Delay One Step1' */
        mcb_pmsm_hall_offset_f280_DWork.DelayOneStep1_DSTATE =
          mcb_pmsm_hall_offset_f28069m__B.Compare;

        /* Update for Delay: '<S131>/Delay One Step' */
        if (mcb_pmsm_hall_offset_f28069m__B.OR) {
          mcb_pmsm_hall_offset_f280_DWork.DelayOneStep_DSTATE =
            mcb_pmsm_hall_offset_f28069m__B.Sum_a;
        }

        /* End of Update for Delay: '<S131>/Delay One Step' */

        /* Update for UnitDelay: '<S120>/Output' */
        mcb_pmsm_hall_offset_f280_DWork.Output_DSTATE =
          mcb_pmsm_hall_offset_f28069m__B.FixPtSwitch;
      }
  ...
  if (1 == runModel) {
    {
      ...
      /* S-Function (memorycopy): '<S2>/Memory Copy1' */
      {
        ...
        uint32_T *meminddst4 = (uint32_T *)
          (&mcb_pmsm_hall_offset_f28069m__B.MemoryCopy1_f);
        *(uint32_T *) (meminddst4) = *(uint32_T *) (memindsrc4);
      }

      /* S-Function (sfix_bitop): '<S2>/Bitwise AND' */
      mcb_pmsm_hall_offset_f28069m__B.BitwiseAND_o =
        mcb_pmsm_hall_offset_f28069m__B.MemoryCopy1_f & 117440512UL;

      /* ArithShift: '<S2>/Shift Arithmetic' incorporates:
       *  S-Function (sfix_bitop): '<S2>/Bitwise AND'
       */
      mcb_pmsm_hall_offset_f28069m__B.ShiftArithmetic_a =
        mcb_pmsm_hall_offset_f28069m__B.BitwiseAND_o >> 24U;

      /* DataTypeConversion: '<S24>/Data Type Conversion1' */
      mcb_pmsm_hall_offset_f28069m__B.DataTypeConversion1_a = (uint16_T)
        mcb_pmsm_hall_offset_f28069m__B.ShiftArithmetic_a;

      /* DataStoreRead: '<S2>/Data Store Read' */
      mcb_pmsm_hall_offset_f28069m__B.DataStoreRead_l =
        mcb_pmsm_hall_offset_f280_DWork.GlobalHallState;

      /* DataTypeConversion: '<S24>/Data Type Conversion2' */
      mcb_pmsm_hall_offset_f28069m__B.DataTypeConversion2_b = (uint16_T)
        mcb_pmsm_hall_offset_f28069m__B.DataStoreRead_l;

      /* DataStoreRead: '<S2>/Data Store Read1' */
      mcb_pmsm_hall_offset_f28069m__B.DataStoreRead1_k =
        mcb_pmsm_hall_offset_f280_DWork.GlobalDirection;

      /* SwitchCase: '<S24>/Detects if the halls reading is valid' */
      switch ((int32_T)mcb_pmsm_hall_offset_f28069m__B.DataTypeConversion1_a) {
       case 5L:
       case 4L:
       case 6L:
       case 2L:
       ...
       case 1L:
        ...
        mcb_pmsm_hall_offset_ValidHalls
          (mcb_pmsm_hall_offset_f28069m__B.DataTypeConversion1_a,
           mcb_pmsm_hall_offset_f28069m__B.DataTypeConversion2_b,
           mcb_pmsm_hall_offset_f28069m__B.DataStoreRead1_k,
           &mcb_pmsm_hall_offset_f28069m__B.Merge3_o,
           &mcb_pmsm_hall_offset_f28069m__B.Merge1_cv,
           &mcb_pmsm_hall_offset_f28069m__B.Merge_a,
           &mcb_pmsm_hall_offset_f28069m__B.ValidHalls);
      ...
      mcb_pmsm_hall_offset_f28069m__B.DataTypeConversion_od =
        mcb_pmsm_hall_offset_f28069m__B.Merge3_o;
      ...
      mcb_pmsm_hall_offset_f28069m__B.eCAP_ii[0] = ECap1Regs.CAP1;
      mcb_pmsm_hall_offset_f28069m__B.eCAP_ii[1] = ECap1Regs.CAP2;

      /* If: '<S23>/If' */
      if ((mcb_pmsm_hall_offset_f28069m__B.ShiftArithmetic_a == 5UL) ||
          (mcb_pmsm_hall_offset_f28069m__B.ShiftArithmetic_a == 3UL)) {
        /* Outputs for IfAction SubSystem: '<S23>/Output 1' incorporates:
         *  ActionPort: '<S26>/Action Port'
         */
        mcb_pmsm_hall_offset_f2_Output1
          (&mcb_pmsm_hall_offset_f28069m__B.Merge_gs);
         ...
         */
        mcb_pmsm_hall_offset_f2_Output0
          (&mcb_pmsm_hall_offset_f28069m__B.Merge_gs);
      ...
      /* Switch: '<S2>/Switch' */
      if (mcb_pmsm_hall_offset_f28069m__B.Merge_gs) {
        /* Switch: '<S2>/Switch' */
        mcb_pmsm_hall_offset_f28069m__B.Switch_k =
          mcb_pmsm_hall_offset_f28069m__B.eCAP_ii[0];
      } else {
        /* Switch: '<S2>/Switch' */
        mcb_pmsm_hall_offset_f28069m__B.Switch_k =
          mcb_pmsm_hall_offset_f28069m__B.eCAP_ii[1];
      }
  ...
  if (1 == runModel) {
    {
      ...
      /* S-Function (memorycopy): '<S3>/Memory Copy1' */
      {
        ...
        uint32_T *meminddst5 = (uint32_T *)
          (&mcb_pmsm_hall_offset_f28069m__B.MemoryCopy1_i);
        *(uint32_T *) (meminddst5) = *(uint32_T *) (memindsrc5);
      }

      /* S-Function (sfix_bitop): '<S3>/Bitwise AND' */
      mcb_pmsm_hall_offset_f28069m__B.BitwiseAND_i =
        mcb_pmsm_hall_offset_f28069m__B.MemoryCopy1_i & 117440512UL;

      /* ArithShift: '<S3>/Shift Arithmetic' incorporates:
       *  S-Function (sfix_bitop): '<S3>/Bitwise AND'
       */
      mcb_pmsm_hall_offset_f28069m__B.ShiftArithmetic_b =
        mcb_pmsm_hall_offset_f28069m__B.BitwiseAND_i >> 24U;

      /* DataTypeConversion: '<S41>/Data Type Conversion1' */
      mcb_pmsm_hall_offset_f28069m__B.DataTypeConversion1_e = (uint16_T)
        mcb_pmsm_hall_offset_f28069m__B.ShiftArithmetic_b;

      /* DataStoreRead: '<S3>/Data Store Read' */
      mcb_pmsm_hall_offset_f28069m__B.DataStoreRead_e =
        mcb_pmsm_hall_offset_f280_DWork.GlobalHallState;

      /* DataTypeConversion: '<S41>/Data Type Conversion2' */
      mcb_pmsm_hall_offset_f28069m__B.DataTypeConversion2_j = (uint16_T)
        mcb_pmsm_hall_offset_f28069m__B.DataStoreRead_e;

      /* DataStoreRead: '<S3>/Data Store Read1' */
      mcb_pmsm_hall_offset_f28069m__B.DataStoreRead1_i =
        mcb_pmsm_hall_offset_f280_DWork.GlobalDirection;

      /* SwitchCase: '<S41>/Detects if the halls reading is valid' */
      switch ((int32_T)mcb_pmsm_hall_offset_f28069m__B.DataTypeConversion1_e) {
       case 5L:
       case 4L:
       case 6L:
       case 2L:
       ...
       case 1L:
         ...
         */
        mcb_pmsm_hall_offset_ValidHalls
          (mcb_pmsm_hall_offset_f28069m__B.DataTypeConversion1_e,
           mcb_pmsm_hall_offset_f28069m__B.DataTypeConversion2_j,
           mcb_pmsm_hall_offset_f28069m__B.DataStoreRead1_i,
           &mcb_pmsm_hall_offset_f28069m__B.Merge3_d,
           &mcb_pmsm_hall_offset_f28069m__B.Merge1_c,
           &mcb_pmsm_hall_offset_f28069m__B.Merge_ly,
           &mcb_pmsm_hall_offset_f28069m__B.ValidHalls_j);
      ...
      mcb_pmsm_hall_offset_f28069m__B.DataTypeConversion_o =
        mcb_pmsm_hall_offset_f28069m__B.Merge3_d;
      ...
      mcb_pmsm_hall_offset_f28069m__B.eCAP_i[0] = ECap2Regs.CAP1;
      mcb_pmsm_hall_offset_f28069m__B.eCAP_i[1] = ECap2Regs.CAP2;

      /* If: '<S40>/If' */
      if ((mcb_pmsm_hall_offset_f28069m__B.ShiftArithmetic_b == 3UL) ||
          (mcb_pmsm_hall_offset_f28069m__B.ShiftArithmetic_b == 6UL)) {
        /* Outputs for IfAction SubSystem: '<S40>/Output 1' incorporates:
         *  ActionPort: '<S43>/Action Port'
         */
        mcb_pmsm_hall_offset_f2_Output1
          (&mcb_pmsm_hall_offset_f28069m__B.Merge_lg);
      ...
      /* Switch: '<S3>/Switch' */
      if (mcb_pmsm_hall_offset_f28069m__B.Merge_lg) {
        /* Switch: '<S3>/Switch' */
        mcb_pmsm_hall_offset_f28069m__B.Switch_f =
          mcb_pmsm_hall_offset_f28069m__B.eCAP_i[0];
      } else {
        /* Switch: '<S3>/Switch' */
        mcb_pmsm_hall_offset_f28069m__B.Switch_f =
          mcb_pmsm_hall_offset_f28069m__B.eCAP_i[1];
      }
  ...
  if (1 == runModel) {
    {
      ...
      /* S-Function (memorycopy): '<S4>/Memory Copy1' */
      {
        ...
        uint32_T *meminddst6 = (uint32_T *)
          (&mcb_pmsm_hall_offset_f28069m__B.MemoryCopy1);
        *(uint32_T *) (meminddst6) = *(uint32_T *) (memindsrc6);
      }

      /* S-Function (sfix_bitop): '<S4>/Bitwise AND' */
      mcb_pmsm_hall_offset_f28069m__B.BitwiseAND =
        mcb_pmsm_hall_offset_f28069m__B.MemoryCopy1 & 117440512UL;

      /* ArithShift: '<S4>/Shift Arithmetic' incorporates:
       *  S-Function (sfix_bitop): '<S4>/Bitwise AND'
       */
      mcb_pmsm_hall_offset_f28069m__B.ShiftArithmetic =
        mcb_pmsm_hall_offset_f28069m__B.BitwiseAND >> 24U;

      /* DataTypeConversion: '<S58>/Data Type Conversion1' */
      mcb_pmsm_hall_offset_f28069m__B.DataTypeConversion1_k = (uint16_T)
        mcb_pmsm_hall_offset_f28069m__B.ShiftArithmetic;

      /* DataStoreRead: '<S4>/Data Store Read' */
      mcb_pmsm_hall_offset_f28069m__B.DataStoreRead =
        mcb_pmsm_hall_offset_f280_DWork.GlobalHallState;

      /* DataTypeConversion: '<S58>/Data Type Conversion2' */
      mcb_pmsm_hall_offset_f28069m__B.DataTypeConversion2 = (uint16_T)
        mcb_pmsm_hall_offset_f28069m__B.DataStoreRead;

      /* DataStoreRead: '<S4>/Data Store Read1' */
      mcb_pmsm_hall_offset_f28069m__B.DataStoreRead1 =
        mcb_pmsm_hall_offset_f280_DWork.GlobalDirection;

      /* SwitchCase: '<S58>/Detects if the halls reading is valid' */
      switch ((int32_T)mcb_pmsm_hall_offset_f28069m__B.DataTypeConversion1_k) {
       case 5L:
       case 4L:
       case 6L:
       case 2L:
       ...
       case 1L:
         ...
         */
        mcb_pmsm_hall_offset_ValidHalls
          (mcb_pmsm_hall_offset_f28069m__B.DataTypeConversion1_k,
           mcb_pmsm_hall_offset_f28069m__B.DataTypeConversion2,
           mcb_pmsm_hall_offset_f28069m__B.DataStoreRead1,
           &mcb_pmsm_hall_offset_f28069m__B.Merge3,
           &mcb_pmsm_hall_offset_f28069m__B.Merge1_d,
           &mcb_pmsm_hall_offset_f28069m__B.Merge_c,
           &mcb_pmsm_hall_offset_f28069m__B.ValidHalls_a);
      ...
      mcb_pmsm_hall_offset_f28069m__B.DataTypeConversion =
        mcb_pmsm_hall_offset_f28069m__B.Merge3;
      ...
      mcb_pmsm_hall_offset_f28069m__B.eCAP[0] = ECap3Regs.CAP1;
      mcb_pmsm_hall_offset_f28069m__B.eCAP[1] = ECap3Regs.CAP2;

      /* If: '<S57>/If' */
      if ((mcb_pmsm_hall_offset_f28069m__B.ShiftArithmetic == 5UL) ||
          (mcb_pmsm_hall_offset_f28069m__B.ShiftArithmetic == 6UL)) {
        /* Outputs for IfAction SubSystem: '<S57>/Output 1' incorporates:
         *  ActionPort: '<S60>/Action Port'
         */
        mcb_pmsm_hall_offset_f2_Output1(&mcb_pmsm_hall_offset_f28069m__B.Merge_m);
         ...
         */
        mcb_pmsm_hall_offset_f2_Output0(&mcb_pmsm_hall_offset_f28069m__B.Merge_m);
      ...
      /* Switch: '<S4>/Switch' */
      if (mcb_pmsm_hall_offset_f28069m__B.Merge_m) {
        /* Switch: '<S4>/Switch' */
        mcb_pmsm_hall_offset_f28069m__B.Switch =
          mcb_pmsm_hall_offset_f28069m__B.eCAP[0];
      } else {
        /* Switch: '<S4>/Switch' */
        mcb_pmsm_hall_offset_f28069m__B.Switch =
          mcb_pmsm_hall_offset_f28069m__B.eCAP[1];
      }
      ...
      /* S-Function (c28xsci_rx): '<S7>/SCI Receive' */
      {
        ...
        if (isHeadReceived) {
          ...
          if ((errFlg != NOERROR) && (errFlg != PARTIALDATA)) {
            mcb_pmsm_hall_offset_f28069m__B.SCIReceive = 0U;
          }

          if ((errFlg == NOERROR) || (errFlg == PARTIALDATA)) {
            memcpy( &mcb_pmsm_hall_offset_f28069m__B.SCIReceive, recbuff,1);
          }
        }
      }

      /* DataTypeConversion: '<S165>/Data Type Conversion1' */
      mcb_pmsm_hall_offset_f28069m__B.DataTypeConversion1 =
        mcb_pmsm_hall_offset_f28069m__B.SCIReceive;

      /* Switch: '<S7>/Switch' */
      mcb_pmsm_hall_offset_f28069m__B.Switch_a =
        (mcb_pmsm_hall_offset_f28069m__B.DataTypeConversion1 > 0.0F);
