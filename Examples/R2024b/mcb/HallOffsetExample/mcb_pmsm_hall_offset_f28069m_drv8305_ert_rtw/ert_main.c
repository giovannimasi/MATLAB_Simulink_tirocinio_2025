...
void rt_OneStep(void)
{
  ...
  mcb_pmsm_hall_offset_f28069m_drv8305_step();
...
int main(void)
{
  ...
  mcb_pmsm_hall_offset_f28069m_drv8305_initialize();
  ...
  enableTimer0Interrupt();
  config_ePWM_TBSync();
  mcb_pmsm_hall_offset_f28069m_drv8305_configure_interrupts();
  ...
  mcb_pmsm_hall_offset_f28069m_drv8305_unconfigure_interrupts();

  /* Terminate model */
  mcb_pmsm_hall_offset_f28069m_drv8305_terminate();
