...
void init_board (void)
{
  ...
  // GpioCtrlRegs.GPBCTRL.bit.QUALPRD2 = 0U;      // GPIO Port B Qualification Control Register Field: Sampling period for pins GPIO50 to GPIO 55
  // GpioCtrlRegs.GPBCTRL.bit.QUALPRD3 = 0U;      // GPIO Port B Qualification Control Register Field: Sampling period for pins GPIO56 to GPIO 58
